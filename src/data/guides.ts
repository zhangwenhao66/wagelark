...
export const guides: Guide[] = [
	...
	},
	{
		...
		description: "29 of the 47 occupations WageLark tracks list an entry education below a bachelor's degree. Ranked by BLS median pay, the top one clears $144,000 a year.",
		published: '2026-08-29',
		updated: '2026-08-29',
		coreSummary: "Of the 47 occupations WageLark tracks BLS wage data for, 29, or 62%, list an entry-level education below a bachelor's degree. The highest-paying of them, air traffic controllers, has a median annual wage of $144,580, more than 41 of the other 46 occupations on this site, ahead of several that require at least a bachelor's degree.",
		sections: [
			{
		...
		faq: [
			{
				...
				answer: "Among the occupations WageLark tracks BLS wage data for, air traffic controllers pay the most without requiring a bachelor's degree: a median annual wage of $144,580 in May 2024, per BLS. The role does require completing an FAA-approved training path and passing FAA Academy training, along with an age-based hiring window, even though the formal education requirement tops out at an associate's degree.",
			},
			{
				question: "Do any no-degree jobs pay over $100,000?",
				answer: "One does, among the 47 occupations covered on this site: air traffic controllers, at a $144,580 median. The next-highest, MRI technologists at $95,480 and dental hygienists at $94,260, both fall just short of six figures at the median, though each occupation's own salary page on this site shows the top 10% of earners clearing $120,000 or more.",
			},
			{
		...
		imageAlt: "Bar chart ranking the top 10 highest-paying occupations that don't require a bachelor's degree by BLS median annual wage, led by air traffic controllers at $144,580.",
	},
];
