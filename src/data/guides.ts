		...
		sections: [
			{
				...
				body: [
					...
					"All 29 are listed with sources in the downloadable dataset linked at the bottom of this page. The full spread runs from air traffic controllers at $148,080 down to bartenders at $33,530, a nearly $115,000 gap within a group that, by BLS's own classification, shares the trait of not requiring a four-year degree to enter.",
				],
			},
			{
				heading: "What BLS's education label leaves out",
				body: [
					"\"No bachelor's degree required\" is not the same as \"no training required,\" and the top of this list makes that clearest. BLS lists an associate's degree as the typical entry path for [air traffic controllers](/air-traffic-controller-salary/), but getting hired actually requires completing an FAA-approved collegiate program or several years of qualifying work experience, passing a medical and background screen, and then finishing training at the FAA Academy before ever working a live position, per this site's own air traffic controller salary page. The role also carries an entry age cutoff (generally 31, extended to 35 for some applicants) and a mandatory retirement age of 56, neither of which shows up in a one-line education field.",
		...
		faq: [
			{
				...
				answer: "Among the occupations WageLark tracks BLS wage data for, air traffic controllers pay the most without requiring a bachelor's degree: a median annual wage of $148,080 in May 2025, per BLS. The role does require completing an FAA-approved training path and passing FAA Academy training, along with an age-based hiring window, even though the formal education requirement tops out at an associate's degree.",
			},
			{
				question: "Do any no-degree jobs pay over $100,000?",
				answer: "One does, among the 48 occupations covered on this site: air traffic controllers, at a $148,080 median. The next-highest, MRI technologists at $95,480 and dental hygienists at $94,260, both fall just short of six figures at the median, though each occupation's own salary page on this site shows the top 10% of earners clearing $120,000 or more.",
			},
			{
				question: "Does BLS's entry-level education field mean that's all the training you need?",
				answer: "No. It describes the typical minimum credential BLS uses to classify an occupation, not the full path to being hired. Several occupations on this list, air traffic controllers and firefighters among them, require additional academy training, licensing exams, or apprenticeship hours well beyond the listed credential. See each occupation's own page on this site for the specific path.",
			},
			{
				question: 'How many of the occupations on this site require a four-year degree or more?',
				answer: "19 of the 48 occupations WageLark currently tracks BLS wage data for list a bachelor's degree or higher as the typical entry-level education; the other 29, or 60%, list something short of that.",
			},
		],
		sources: [
