...
export const guides: Guide[] = [
		...
		faq: [
			{
				...
				answer: 'BLS\'s May 2024 figure puts hygienist pay at a $94,260 median annually, or $45.32 an hour. "Median" means half of hygienists earned more and half earned less. It is generally a more useful figure than a simple average for wage data, since a small number of very high earners can skew an average upward.',
			},
			{
				question: 'What is the highest-paying setting for a dental hygienist?',
				answer: 'Among the industry categories BLS tracks, the dentist-office setting paid the highest median wage, $94,570 for May 2024, just above the physician-office figure ($84,720) and the government-employer figure ($77,940). BLS does not publish a state-by-state breakdown on this page; per-state figures require the BLS OEWS state wage tables directly.',
			},
			{
				question: 'How much do the lowest- and highest-paid dental hygienists make?',
				answer: 'BLS reports that hygienists in the bottom decile earned under $66,470 in May 2024, while the top decile cleared $120,060. The gap mostly reflects hours worked (many in the role choose part-time schedules) and regional cost-of-living differences, not a single factor.',
			},
			{
				question: 'Is dental hygiene a growing field?',
				answer: 'Yes. BLS projects 7% employment growth for this occupation over the 2024-2034 decade, a pace the agency puts in its fastest-growth tier, adding about 15,500 positions along the way.',
			},
			{
				question: 'How long does it take to become a dental hygienist?',
				answer: 'BLS lists an associate degree as this field\'s typical entry-level education, generally a two-year program of full-time study, though BLS does not itself state an exact number of years on this page.',
			},
			{
				question: 'Who gets paid more, RN or RDH?',
				answer: 'The two are close, per BLS\'s May 2024 data: dental hygienists had a median of $94,260, just above the $93,600 median for registered nurses reported on this site\'s [how long is nursing school](/how-long-is-nursing-school/) guide. Both figures come from BLS\'s OEWS wage survey for the same year, though the two occupations require different entry credentials: a two-year associate credential for this role versus a bachelor\'s, associate\'s, or diploma path for registered nurses.',
			},
			{
				question: 'Is dental hygiene harder than nursing?',
				answer: "That's subjective, and BLS doesn't rate occupations by difficulty, but the two credentials differ in scope. BLS lists an associate's degree as the typical entry-level education for this occupation and, via one of several accepted paths, for registered nurses too, so the base training length is often similar. Where they diverge is breadth: nursing covers a much wider range of settings, patient conditions, and clinical decision-making across a career, while dental hygiene is a narrower, single-setting scope centered on preventive oral care under a dentist's supervision. Neither BLS nor this page has a way to rank the two by difficulty; the honest answer is that they're different kinds of work, not that one is measurably harder than the other.",
			},
		],
		sources: [
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Graduating does not mean practicing yet. Every state requires a license, which means passing the NAPLEX plus a state-specific law exam (commonly the MPJE) and logging a state-set number of supervised intern hours, work most students complete during school rather than after. BLS notes this licensing step typically adds a few more months, not years, to the timeline. Pharmacists aiming for a clinical or hospital specialty often add a one- to two-year residency after the Pharm.D., though it is not required to practice in most general pharmacy roles. Outside any clinical licensing track, this site\'s [truck driver salary guide](/truck-driver-salary/) reports a considerably lower $57,440 median for heavy and tractor-trailer drivers in May 2024, with 4% projected growth through 2034.',
				],
			},
			{
				heading: 'Job outlook',
		...
		sections: [
			{
				...
				body: [
					...
					'The percentile range is moderate compared to some other occupations on this site: the bottom 10% of PTs earned less than $74,420, and the top 10% earned more than $132,500 in May 2024, roughly a $58,000 gap. That is consistent with a single-credential profession where pay differences come mainly from setting, geography, and years of experience rather than large differences in required qualifications. For another clinical field\'s BLS wage data by percentile, see this site\'s [respiratory therapist salary](/respiratory-therapist-salary/) guide.',
				],
			},
			{
		...
		faq: [
			{
				...
				answer: 'BLS puts the 2024 figure at $101,020 a year for the occupation, or $48.57 an hour.',
			},
			{
				question: 'Do physical therapists need a doctoral degree?',
				answer: 'Yes. Since the field transitioned to doctoral-level entry education, practicing PTs need the DPT credential plus a passing score on the National Physical Therapy Examination and state licensure.',
			},
			{
				question: 'What setting pays physical therapists the most?',
				answer: '$108,110 at home health agencies is the highest of the four employer categories BLS tracked for May 2024. A residential and skilled-care facility setting followed at $105,330, hospitals came in at $105,140, and standalone outpatient PT clinics trailed the group at $94,860.',
			},
			{
				question: 'Is physical therapy a growing field?',
				answer: 'Yes, per BLS: 11% projected job growth for the occupation between 2024 and 2034, well above the roughly 3% average across all U.S. occupations, adding an estimated 29,300 positions over the decade.',
			},
			{
				question: 'How long does it take to become a physical therapist?',
				answer: 'A typical four-year undergraduate degree with prerequisite coursework, followed by a CAPTE-accredited DPT program that BLS describes as running about three years, adds up to roughly seven years before a graduate is eligible to sit for the licensing exam, per this site\'s [how to become a physical therapist](/how-to-become-a-physical-therapist/) guide. Some PTs add an optional one-year clinical residency on top of that.',
			},
			{
				question: 'Is PT harder than RN?',
				answer: "BLS doesn't rate occupations by difficulty, but the credentialing timelines differ substantially. Physical therapy runs roughly seven years total, combining a four-year undergraduate degree with a three-year graduate DPT program. Registered nursing moves faster: per this site's [how long is nursing school](/how-long-is-nursing-school/) guide, BLS lists both the bachelor's (BSN) and associate's (ADN/ASN) nursing paths at about four years to completion, several years shorter than the DPT track.",
			},
		],
		sources: [
		...
		faq: [
			{
				...
				answer: 'PAs practice medicine with a licensed physician signing off and complete a master\'s-level program (typically 2+ years post-bachelor\'s), while physicians complete medical school (4 years) plus residency (3-7+ years depending on specialty) and are independently licensed to practice. What a PA is permitted to do without a physician\'s direct sign-off differs from state to state.',
			},
			{
				question: 'How much do physician assistants make?',
				answer: 'For May 2024, BLS puts PA pay at a $133,260 median annually, or $64.07 an hour. The highest-paying tracked employer type is government work, at $151,470.',
			},
			{
				question: 'What degree do you need to become a physician assistant?',
				answer: 'Graduate-level training through a program accredited for PA education, plus passing PANCE, the profession\'s licensing test, and obtaining state licensure. Most programs also expect an undergraduate degree completed beforehand, along with science classes and hands-on clinical exposure.',
			},
			{
				question: 'Do physician assistants work in specific specialties?',
				answer: 'PAs work across most medical specialties rather than being limited to one. Emergency care, psychiatry, and family practice are among the settings BLS lists most often, on top of surgical and pediatric teams. That range across fields lets one PA move between them across a career, something a physician, already locked into one field by years of residency training, generally cannot do.',
			},
			{
				question: 'Can you make $200,000 as a PA?',
				answer: 'Not typically, per national BLS data. The top decile of PAs earned more than $182,200 in May 2024, the highest figure BLS publishes for the occupation, short of $200,000. See this site\'s [PA salary guide](/physician-assistant-salary/) for the full percentile and industry breakdown; pay varies by specialty and setting in ways this national figure does not capture.',
			},
			{
				question: 'Who is higher paid, NP or PA?',
				answer: "PAs earned more, per BLS's May 2024 data: a $133,260 median that year, versus $129,210 for NPs, roughly a $4,050 gap. Both are graduate-trained clinical roles that typically require a master's degree, though PAs work with physician oversight in most states while NPs increasingly have independent practice authority depending on the state. See this site's [nurse practitioner salary](/nurse-practitioner-salary/) guide for the full NP wage breakdown.",
			},
			{
				question: 'Is PA a stressful job?',
				answer: "BLS doesn't formally rate occupations for stress, but its own description of the work points to real demands: treating patients is, in BLS's words, both physically and emotionally demanding, and PAs spend much of the day standing or walking between patients, with those who work in operating rooms often standing for extended stretches. Most PAs work full time, and schedules can include nights, weekends, or holidays; BLS also notes PAs may be on call, meaning they must be ready to respond to a work request on short notice.",
			},
		],
		sources: [
		...
		faq: [
			{
				...
				answer: 'A classroom certificate course usually finishes in under twelve months. Some people instead start with only a diploma from high school and learn on the job from an employer, though this route is not open everywhere, because a few states mandate certification whichever way you trained.',
			},
			{
				question: 'Do you need certification to be a phlebotomist?',
				answer: 'It depends on the state, since a few legally mandate a credential of some kind. Even in states with no legal mandate, BLS notes most employers prefer candidates who hold a recognized credential, since it is often the more reliable path to being hired at big hospital networks and testing labs.',
			},
			{
				question: 'How much do phlebotomists make?',
				answer: 'The May 2024 median for phlebotomists is $43,660 a year ($20.99 per hour) per BLS, and the top-paying industry is outpatient care, at a $48,450 median.',
			},
			{
				question: 'Is phlebotomy a good first job in healthcare?',
				answer: 'Many people use it that way. The training is comparatively short (often under a year) and low-cost, and the hands-on time with patients is valued by admissions programs for some better-paid credentials such as medical assisting, nursing, or imaging programs. Projected growth for the role itself is 6% through 2034, per BLS, but BLS data describes the aggregate labor market, not a recommendation for any specific person.',
			},
			{
	...
	},
	{
		...
		sections: [
			...
			},
			{
				heading: 'Job outlook',
				body: [
					'BLS projects 9% employment growth for flight attendants from 2025 to 2035, classified as much faster than average, taking the occupation from 133,700 jobs to roughly 145,500, a net gain of about 11,800 positions. On top of that net growth, BLS separately estimates about 18,500 openings a year on average over the decade, since most yearly openings come from replacing workers who transfer out or retire rather than from new positions alone. Growth in air travel demand, plus regulatory minimum staffing requirements tied to aircraft passenger capacity, are the main drivers BLS cites. Airlines cannot simply run more flights without proportionally more crew, which links growth directly to industry capacity expansion in a way that is less true for some other service occupations.',
					"The other crew role on the same flight deck follows a similar seniority-driven pay pattern but at a much higher scale: this site's [pilot pay guide](/how-much-do-pilots-make/) puts the May 2025 median for airline pilots, copilots, and flight engineers at $232,140, roughly three and a half times the flight attendant median above.",
				],
			},
		],
		faq: [
			...
			},
			{
				...
				answer: 'Mainly seniority. At most of the major carriers, pay follows a union-negotiated scale where the hourly rate climbs a great deal the longer someone has been on the job, and the most senior crew members also get first pick of the higher-paying international and long-haul routes.',
			},
			{
				question: 'Do flight attendants need a college degree?',
				answer: 'No. BLS lists high-school completion (or its equivalent) as the typical entry-level education requirement, along with airline-provided initial training (moderate-term on-the-job training) and FAA certification, which is required by law before working as a flight attendant.',
			},
			{
		...
		imageAlt: 'Bar chart showing flight attendant annual wage by percentile: 10th percentile $35,110, median $63,580, 90th percentile $136,430, based on BLS May 2025 data.',
	},
	{
	...
	},
	{
		...
		updated: '2026-08-04',
		socCode: '29-1151',
		coreSummary: 'The median annual wage for Certified Registered Nurse Anesthetists (CRNAs) was $223,210 in May 2024, according to the Bureau of Labor Statistics, well above the $129,210 median for nurse practitioners and $128,790 for nurse midwives, the two other advanced practice nursing roles BLS tracks on the same page. Employment is projected to grow 9% from 2024 to 2034, adding roughly 4,600 jobs, and as of 2025 every accredited entry program now awards a doctoral degree, not the master\'s degree BLS still lists as the typical entry-level education.',
		sections: [
			{
				heading: 'What CRNAs earn, and why this page needs some unpacking',
				body: [
					"BLS tracks Certified Registered Nurse Anesthetists (CRNAs) under SOC code 29-1151, and reports a median annual wage of $223,210 for May 2024, among the highest this site tracks outside of physician roles like [psychiatrists](/psychiatrist-salary/) at $281,870. That figure sits on a BLS page titled \"Nurse Anesthetists, Nurse Midwives, and Nurse Practitioners,\" which covers all three advanced practice registered nurse (APRN) roles together. The page does break out a separate median wage for each: nurse practitioners at $129,210 and nurse midwives at $128,790, both well below the CRNA figure, which reflects the more extensive additional training and the surgical/procedural setting CRNAs typically work in.",
					...
					"For context on how CRNA pay compares with other clinical roles that require graduate-level training beyond a bachelor's degree, see this site's guides to [pharmacist salary](/pharmacist-salary/) and [physical therapist salary](/physical-therapist-salary/), both licensed clinical professions with their own BLS-reported wage data. This site's [surgical tech salary](/surgical-tech-salary/) guide covers BLS wage data and job outlook for another surgical-setting role. A considerably lower-paid graduate-credentialed role this site tracks, [speech-language pathology](/speech-language-pathologist-salary/), posts a $97,870 BLS median by comparison, nearly $125,000 below the CRNA figure above.",
				],
			},
			{
		...
		faq: [
			{
				...
				answer: 'BLS puts CRNA pay at a $223,210 median for May 2024, well above the other two advanced-practice nursing occupations (nurse practitioner and nurse midwife) this BLS Handbook page covers.',
			},
			{
				question: 'Do CRNAs need a doctorate degree?',
				answer: 'According to BLS\'s own summary table, technically yes: it still lists a master\'s degree as the required credential, though that is outdated. COA has required every accredited program in the field to award a doctorate (DNP or DNAP) since fully transitioning in 2025, a change that has been rolling out since 2022.',
			},
			{
				question: 'Is CRNA a growing career?',
				answer: 'Yes. The agency\'s 2024-34 projections put nurse anesthetist employment up 9%, a pace within BLS\'s fastest growth bracket, with about 4,600 new positions added. Growth for CRNAs trails the 40% rate BLS assigns the nurse-practitioner role over that same stretch; CRNA pay still leads the group.',
			},
			{
				question: 'How does CRNA pay compare to nurse practitioner or nurse midwife pay?',
				answer: 'By a wide margin. The May 2024 CRNA figure of $223,210 tops both other advanced-practice roles on that same BLS page. The nurse-practitioner figure came in at $129,210; nurse-midwife, $128,790.',
			},
			{
				question: 'How many years does it take to become a CRNA?',
				answer: 'Add up the credentialing steps BLS and COA describe: a nursing bachelor\'s degree as the starting point, plus at least one year of critical-care RN experience (BLS\'s stated minimum before applying), plus a doctoral nurse-anesthesia track that COA\'s accreditation standard sets at a 36-month-minimum length. Stacked together, that floor works out to roughly eight years. Most applicants take longer in practice, since many build several years of ICU experience first and some programs run past the 36-month minimum.',
			},
			{
				question: 'Is CRNA the highest-paid nursing role?',
				answer: 'Yes, among the nursing occupations BLS tracks with published wage data. CRNA\'s $223,210 median clears the nurse-practitioner figure ($129,210) and the nurse-midwife figure ($128,790) on that same occupational page, plus the $93,600 BLS median for registered nurses broadly. BLS does not rank every nursing title on one list, but of the specific roles it does track individually, CRNA tops them.',
			},
			{
				question: 'Can a CRNA make $500,000 a year?',
				answer: "Not per BLS's published numbers. The highest decile the agency reports touching this occupation is a combined top 10% spanning the nurse-practitioner, nurse-midwife, and CRNA group together, at more than $217,270 for May 2024, still nowhere near $500,000. That OEWS survey measures base wages employers report; it would not necessarily pick up unusually high total pay for independent-contractor or locum tenens CRNA work, which BLS does not break out separately from employed CRNA pay.",
			},
			{
				question: 'Is CRNA school harder than med school?',
				answer: "That's subjective, but the two tracks differ in measurable ways. A CRNA doctoral program requires a nursing bachelor's degree already in hand, at least a year of critical-care RN experience, and a 36-month-minimum doctoral track per COA, all on top of already being a licensed nurse. Medical school runs four years toward an MD or DO after undergrad, with no nursing or clinical-experience prerequisite, then a residency spanning three to seven years by specialty before a physician can practice unsupervised. Counting total years from undergrad to unsupervised practice, physicians take longer in most specialties; judged by admissions competitiveness or curriculum intensity, there's no BLS or other verifiable dataset here that settles it either way.",
			},
		],
		sources: [
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'BLS projects 40% employment growth for nurse practitioners specifically from 2024 to 2034, adding roughly 128,400 jobs (from 320,400 to about 448,800). That is the fastest growth of the three related roles on this BLS page, well ahead of the 9% projected for CRNAs and 11% for nurse midwives, and far above the roughly 3% average BLS projects across all occupations for the same period. BLS attributes overall demand for advanced practice registered nurses to an aging population, rising rates of chronic disease, and a broader shift toward team-based primary and specialty care, without breaking that explanation out separately by role. Elsewhere on this site, a comparably strong BLS growth outlook shows up for [speech-language pathologists](/speech-language-pathologist-salary/), projected to grow 17% through 2035 from a 2025 base of 193,400 workers.',
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'Physician assistant pay sits in the middle of a cluster of graduate-trained clinical roles this site tracks. [Nurse practitioners](/nurse-practitioner-salary/), a role BLS reports separately, had a lower May 2024 median of $129,210, despite both occupations typically requiring a master\'s degree for entry. [Pharmacists](/pharmacist-salary/), who require a doctoral degree (PharmD), had a somewhat higher median of $140,910. [Certified Registered Nurse Anesthetists](/crna-salary/), who now require a doctoral degree for new entrants, had a median of $223,210, well above all three of the other roles.',
		...
		faq: [
			{
				...
				answer: 'In May 2024, BLS put median annual pay for the role at $43,460, equivalent to $20.90 an hour, based on its own OEWS wage survey. Actual take-home pay can differ from that figure, since scheduling for the role is commonly hourly rather than a fixed salary, and hours worked vary by employer.',
			},
			{
				question: 'Do pharmacy technicians need to be certified?',
				answer: "Sometimes; rules differ by state. BLS says a good share of states impose some form of oversight on the role, which can mean a licensing exam, a training course, a background screen, or recurring coursework requirements, though the exact combination varies. Certification isn't universally required, but a number of states and individual employers choose to require it anyway, which BLS says can be a practical hiring edge even where the law doesn't mandate it.",
			},
			{
				question: 'Which industry pays pharmacy technicians the most?',
				answer: 'The ambulatory-care category tops BLS\'s May 2024 breakdown at $49,920, with hospitals just under that at $49,310. National drugstore chains and neighborhood pharmacies, the traditional retail setting, sat at the bottom of the list at $37,900.',
			},
			{
				question: 'Is pharmacy technician a growing occupation?',
				answer: 'BLS projects the pharmacy-tech workforce expanding six percent over the 2024-2034 decade, quicker than the all-occupation average, adding a net 31,500 jobs. Separately, BLS estimates roughly 49,000 openings a year on average across the decade, though most of that figure reflects technicians leaving the field rather than newly created roles.',
			},
			{
				question: 'Who gets paid more, CNA or pharmacy tech?',
				answer: 'Pharmacy techs came out slightly ahead: a median of $43,460 for May 2024, per BLS, compared with $42,260 for nursing assistants in May 2025, per this site\'s [how to become a CNA](/how-to-become-a-cna/) guide. The two figures come from different BLS survey years, since BLS refreshes occupations on its own schedule, so this is a close comparison rather than an exact same-year one.',
			},
			{
				question: 'Is becoming a pharmacist tech hard?',
				answer: "Not by BLS's own bar to entry. A completed high school education is the typical requirement, and most people qualify through employer-provided training completed within a year, or by finishing a shorter certificate track at a two-year technical school. That puts pharmacy techs among the more accessible allied-health roles this site tracks; whether a specific state also layers on an exam, background screening, or continuing-education requirement varies, and a state's own labor board is the place to confirm specifics.",
			},
		],
		sources: [
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'The gap between the highest- and lowest-paying tracked industries, about $7,490, is notably narrower than the roughly $12,020 industry gap this site\'s pharmacy technician salary guide reports for that occupation. Since the large majority of dental assistants work in dentists\' offices, not in government or physician settings, the industry breakdown matters less to a typical dental assistant\'s actual pay than it does for occupations spread more evenly across employer types.',
				],
			},
			{
		...
		faq: [
			{
				...
				answer: 'BLS\'s May 2024 figure: $47,300 a year for someone doing this work, or $22.74 an hour, just under BLS\'s figure for the whole U.S. workforce combined that same year, $49,500.',
			},
			{
				question: 'Do dental assistants need a degree?',
				answer: 'It depends on the state. BLS reports that a share of states call for finishing an approved training program, commonly about a year and capped by a diploma or certificate (associate\'s-degree tracks exist but are rarer), plus passing an exam. Elsewhere, no schooling is mandated by law; assistants can instead pick up the role through employer-provided coaching. Coronal polishing is one example of an expanded function that typically needs its own separate licensure or certification, even in states with no baseline schooling requirement.',
			},
			{
				question: 'Which industry pays dental assistants the most?',
				answer: '$53,660 in the public sector (outside of schools and hospitals) tops the three-category list BLS tracks for May 2024. Dental offices, the setting employing practically the entire workforce, land right around the overall median at $47,250, while physician offices pay the least, at $46,170.',
			},
			{
				question: 'How does dental assistant pay compare to dental hygienist pay?',
				answer: 'BLS puts dental hygienist pay at $94,260 for May 2024, roughly twice the $47,300 dental assistant figure. Schooling explains most of the gap: hygienists go through a two-year accredited program capped by a licensing exam, while entering as an assistant is usually much quicker, through a shorter certificate track or on-the-job coaching.',
			},
			{
				question: 'Is dental assisting a growing occupation?',
				answer: 'BLS projects 6% growth in this occupation between 2024 and 2034, quicker than the U.S. all-occupation average, adding a net 24,400 jobs. Separately, BLS puts average yearly openings at about 52,900 across that same ten-year window, though the bulk of that figure reflects assistants leaving the role rather than the headcount actually expanding.',
			},
			{
				question: 'Who gets paid more, CNA or dental assistant?',
				answer: 'In May 2024, dental assistants had a $47,300 median, per BLS, compared with $42,260 for nursing assistants in May 2025, per this site\'s [how to become a CNA](/how-to-become-a-cna/) guide. The two figures come from different BLS survey years, so this is a close comparison rather than an exact same-year one.',
			},
			{
				question: 'Is dental assistant school hard?',
				answer: "It depends on the state, and for many people there's no formal schooling requirement at all. Per BLS, a portion of states require completing an accredited certificate track, typically around a year long and ending in a diploma, plus passing an exam. Elsewhere, nothing formal is required, letting a newcomer pick up the role through hands-on coaching from a dentist or an experienced coworker instead. That flexibility makes it one of the more approachable starting points among the allied-health roles this site tracks.",
			},
		],
		sources: [
	...
	},
	{
		...
		description: 'BLS puts the median medical assistant salary at $45,690 a year. See the wage range by percentile, by industry, and how it compares to a physician assistant.',
		published: '2026-08-06',
		updated: '2026-08-28',
		socCode: '31-9092',
		coreSummary: 'The median annual wage for medical assistants was $45,690 in May 2025, according to the U.S. Bureau of Labor Statistics, or $21.97 an hour. The bottom 10% earned less than $36,050, and the top 10% earned more than $59,310. Outpatient care centers paid the highest industry median at $48,560, while offices of other health practitioners paid the least, at $38,400. BLS projects 13% employment growth through 2035, much faster than average, with about 109,700 openings projected each year.',
		sections: [
			{
	...
	},
	{
		...
		description: 'BLS puts the median air traffic controller salary at $148,080 a year. See the full wage range by percentile, by employer, and the FAA age rules that shape it.',
		published: '2026-08-09',
		updated: '2026-08-30',
		socCode: '53-2021',
		coreSummary: 'The median annual wage for air traffic controllers was $148,080 in May 2025, according to the U.S. Bureau of Labor Statistics, nearly three times the $50,980 median across all U.S. occupations that year. The bottom 10% earned less than $78,420, and the top 10% earned more than $215,610. Federal government employers, who employ the large majority of controllers, paid a median of $156,250, well above the $83,890 median for controllers working in air traffic support activities.',
		sections: [
			{
		...
		sources: [
			{ label: 'BLS Occupational Outlook Handbook: Air Traffic Controllers (accessed 2026-08-30 via direct fetch with a UA string carrying a declared contact URL, returned 200, data from May 2025)', url: 'https://www.bls.gov/ooh/transportation-and-material-moving/air-traffic-controllers.htm' },
		...
		imageAlt: 'Bar chart showing air traffic controller annual wage by percentile: 10th percentile $78,420, median $148,080, 90th percentile $215,610, based on BLS May 2025 data.',
	},
	{
		...
		sections: [
			{
				...
				body: [
					'The Bureau of Labor Statistics tracks this role under SOC code 47-2111. For May 2025, BLS reported a median annual wage of $63,190, or $30.38 an hour, for the roughly 821,000 people employed as electricians nationwide. The bottom 10% of earners made less than $42,640 a year, while the top 10% made more than $108,510, a spread of more than $65,000 that reflects differences in experience, license level, employer type, and region, not any single factor. BLS describes the job itself as physically demanding work, noting that electricians need enough strength to move components that can weigh up to 50 pounds and must be able to identify wires by color, on top of the troubleshooting skills the role requires day to day.',
					"BLS also places electricians against two broader groupings on the same page. The median for construction trades workers as a whole was $58,150, and the median across all occupations in the economy was $50,980. Electricians sit above both comparison figures, though BLS does not break out how much of that gap owes to the trade's licensing requirements versus other factors like union coverage or regional demand.",
					'On growth, BLS projects 9% employment growth for electricians from 2025 to 2035, compared with 6% for construction trades workers as a whole and roughly 3% for all occupations combined. BLS classifies that as "much faster than average," one of the stronger outlooks among the skilled trades this site has covered so far.',
				],
			},
			{
				heading: 'Industry breakdown, and where apprentices fit in',
				body: [
					'BLS breaks out May 2025 wages by industry for electricians into four categories. Government employers, excluding state and local education and hospitals, paid the highest median at $79,820. Manufacturing followed at $74,550. Electrical contractors and other wiring installation contractors, the industry BLS says employs 66% of electricians (the largest single share by far), paid a median of $61,570, close to the occupation-wide figure. Employment services, which covers staffing agencies, paid the lowest of the four tracked categories at $57,760.',
					"About 7% of electricians are self-employed, per BLS, most often in residential construction, where BLS notes they may be able to set their own schedule. BLS also states that apprentices earn less than fully trained electricians and that their pay rises as they take on more responsibility during the multi-year apprenticeship, though the Handbook page does not publish a separate apprentice wage figure distinct from the fully qualified median above.",
			...
			},
			{
				...
				body: [
					...
					"For readers comparing [entry paths that skip a bachelor's degree](/highest-paying-jobs-without-a-degree/), electricians sit at the higher-paying end of the occupations covered on this site so far. [Becoming a CNA](/how-to-become-a-cna/) requires a 75-hour minimum training program rather than a multi-year apprenticeship, and BLS puts the median nursing assistant wage at $42,260, well below the electrician median. [Medical assistants](/medical-assistant-salary/), whose typical entry credential BLS lists as a postsecondary nondegree award, unlike the apprenticeship electricians go through, have a median of $45,690. Electricians, despite requiring no postsecondary credential at all beyond a high school diploma, out-earn both at the median, though BLS does not track how apprenticeship length, licensing requirements, or industry mix account for that gap. [HVAC certification](/hvac-certification/), covering EPA 608 requirements, training, and pay, is another entry path this site covers.",
				],
			},
			{
				heading: 'Job outlook, and what BLS says is driving demand',
				body: [
					'BLS projects 9% employment growth for electricians from 2025 to 2035, adding an estimated 75,900 jobs (to a projected 896,900 total by 2035) and about 72,700 openings a year on average. As with most occupations BLS tracks, it attributes many of those annual openings to the need to replace workers who transfer to other occupations or leave the labor force entirely, such as to retire, rather than to newly created positions alone.',
					"BLS attributes underlying growth to electricians continuing to be needed to link power generation systems, including solar and wind, to homes, businesses, and the broader power grid, plus a newer factor: rising electricity demand tied to growing use of artificial intelligence and data centers. BLS expects that demand to require upgrades to the national power grid and new infrastructure, which it says should create additional job opportunities for electricians to install and connect electrical systems and power-generation sources to the grid.",
	...
	},
	{
		...
		description: 'BLS puts the median firefighter salary at $59,280 a year, with 4% growth projected through 2035. Here is the full wage range by percentile and by employer type.',
		published: '2026-08-11',
		updated: '2026-09-09',
		socCode: '33-2011',
		coreSummary: 'The median annual wage for firefighters was $59,280 in May 2025, according to the U.S. Bureau of Labor Statistics, or $28.50 an hour. The bottom 10% earned less than $34,910 while the top 10% earned more than $101,040. BLS projects 4% employment growth from 2025 to 2035, about as fast as the roughly 3% average across all occupations, adding an estimated 13,100 jobs and about 26,800 openings a year on average.',
		sections: [
			{
				heading: 'What firefighters earn, and how that compares to the broader labor market',
				body: [
					'The Bureau of Labor Statistics tracks this role under SOC code 33-2011. For May 2025, BLS reported a median annual wage of $59,280, or $28.50 an hour, for the roughly 355,300 people employed as firefighters nationwide. On the same page, BLS lists the median across all occupations in the economy as $50,980, putting firefighters above [that broader national wage benchmark](/salary-statistics-2026/). The bottom 10% of firefighters earned less than $34,910 a year, while the top 10% earned more than $101,040, a spread of roughly $66,000 that BLS attributes to differences in department size, rank, region, and years of service rather than any single factor.',
					'These figures cover paid, career firefighters only. BLS is explicit that its employment and wage numbers "exclude volunteer firefighters, who share the same duties as paid firefighters," and notes separately that volunteers "account for the largest share of firefighters nationwide, especially in communities of fewer than 25,000." That means the $59,280 median describes the career workforce BLS surveys for pay, not the full population of people who do firefighting work in the United States.',
					'BLS also groups firefighters under a broader "firefighting and prevention workers" category, which also includes fire inspectors and investigators and had a slightly higher median hourly wage of $28.67 (about $59,630 a year using the standard 2,080-hour work year BLS applies) for May 2025. The firefighter-specific figure used throughout this page, $59,280, is the narrower number for the occupation itself.',
				],
			},
			{
				heading: 'Pay by government level, and where career firefighters actually work',
				body: [
					'BLS breaks out May 2025 median wages for firefighters by the three employer categories it tracks: state government, excluding education and hospitals, at $64,980; federal government, excluding postal service, at $63,270; and local government, excluding education and hospitals, at $59,850. The spread between the highest- and lowest-paying tier is about $5,100, a much narrower gap than some other public-facing occupations this site has covered, where the difference between the best- and worst-paying industry can run into the tens of thousands of dollars.',
					'Despite paying the least of the three tiers, local government is where the large majority of career firefighters actually work: BLS puts local government at 87% of firefighter employment, versus 4% for state government and 2% for federal government (excluding postal service). BLS does not publish a combined percentage that accounts for the remaining employers, and it does not explain why state and federal positions pay modestly more than local ones on this page; it presents the industry breakdown descriptively rather than attributing the gap to a specific cause such as unionization, cost-of-living adjustments, or department budgets.',
			...
			},
			{
				...
				body: [
					...
					"Firefighters out-earn some, but not all, of the other entry paths this site has covered that skip a bachelor's degree. [Electricians](/electrician-salary/) sit a bit higher at the median, at $63,190 versus $59,280 for firefighters, and BLS lists the same nominal hiring bar of a high school diploma for both, though electricians train through a 4- to 5-year, mostly on-the-job apprenticeship rather than a fire academy plus EMT certification. [CNAs](/how-to-become-a-cna/), by contrast, need a much shorter training bar, a state-approved program with a federal floor of 75 hours under 42 CFR § 483.152, and BLS puts the nursing assistant median at $42,260, well below both firefighters and electricians. [Ironworkers](/ironworker-salary/), also a high school diploma-entry trade on this site, land on either side of the firefighter figure depending on which of the two BLS ironworking occupations is in question: structural iron and steel workers post a $62,780 median, about $3,500 above firefighters, while reinforcing iron and rebar workers come in at $58,970, just under. BLS does not quantify how much of these gaps owes to training length, licensing requirements, physical risk, or other factors it does not isolate on any of these pages.",
				],
			},
			{
				heading: 'Job outlook, and why growth trails some other trades on this site',
				body: [
					'BLS projects 4% employment growth for firefighters from 2025 to 2035, which it classifies as "about as fast as average," slightly ahead of the roughly 3% growth rate it projects across all occupations combined. That is a slower projected rate than some other occupations this site has covered; electricians, for comparison, carry a 9% "much faster than average" projection over the same period. BLS attributes the more modest firefighter outlook partly to a long-term decline in structure fires and fire fatalities tied to improved building materials and building codes, while noting that wildland firefighters will still be needed to combat active fires and manage fire risk, and that firefighters generally will continue responding to medical emergencies, which BLS says make up most calls firefighters answer, not just fires.',
					'BLS estimates about 26,800 openings for firefighters each year on average over the decade, adding up to a projected employment change of 13,100 jobs by 2035. As with most occupations BLS tracks, it attributes many of those annual openings to the need to replace workers who transfer to other occupations or leave the labor force, such as to retire, rather than to newly created positions alone.',
		...
		faq: [
			{
				...
				answer: 'For May 2025, BLS puts firefighter pay at $59,280 in the middle of the range, or $28.50 an hour: half the workforce earns more, half earns less. That number describes people drawing a firefighter paycheck; BLS leaves volunteers out of its pay and staffing figures entirely.',
			},
			{
				question: 'What is the highest-paying employer type for firefighters?',
				answer: 'BLS breaks employers into three government tiers, and for May 2025 the top payer is state government at $64,980 (its figure leaves out school and hospital employers), followed by federal agencies at $63,270, then $59,850 for cities and counties. Yet about 87% of the paid firefighter workforce, per BLS, ends up on a local-government payroll despite that tier sitting at the bottom of the pay scale.',
			},
			{
				question: 'How much do the lowest- and highest-paid firefighters make?',
				answer: 'Firefighters in the bottom decile made under $34,910 a year in May 2025, per BLS, while those in the top decile brought home upward of $101,040. No single factor explains that spread; BLS points broadly to years on the job, department size, region, and rank.',
			},
			{
				question: 'What education do you need to become a firefighter?',
				answer: "The entry bar BLS describes is modest: a diploma from high school plus instruction covering emergency medical basics, usually completed at a fire academy, with no four-year degree needed to get in the door. BLS's own entry-education label for this occupation covers jobs where a single postsecondary exam or credential does the work a degree would elsewhere, which tracks with the EMT credential departments generally expect on top of academy training.",
			},
			{
				question: 'Is firefighting a growing occupation?',
				answer: "Yes, modestly: firefighting employment is on track to grow 4% between 2025 and 2035, per BLS, a pace BLS treats as roughly in line with the broader job market's growth rate. Expect roughly 13,100 net new jobs and somewhere near 26,800 yearly openings over that stretch, most of them created by workers retiring or transferring out rather than by roles that did not exist before.",
			},
		],
		sources: [
			{ label: 'BLS Occupational Outlook Handbook: Firefighters (accessed 2026-09-09, data from May 2025)', url: 'https://www.bls.gov/ooh/protective-service/firefighters.htm' },
			{ label: 'BLS Occupational Employment and Wage Statistics, National May 2025 estimates (Table 1)', url: 'https://www.bls.gov/news.release/ocwage.t01.htm' },
		...
		imageAlt: 'Bar chart showing firefighter annual wage by percentile: 10th percentile $34,910, median $59,280, 90th percentile $101,040, based on BLS May 2025 data.',
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'BLS states directly that apprentices earn less than fully trained plumbers, pipefitters, and steamfitters, and that their pay rises as they take on more responsibility during the program, but the Occupational Outlook Handbook page does not publish a separate apprentice wage figure distinct from the fully qualified median. The number BLS does publish is the occupation-wide median for May 2025, $63,800 a year, or $30.67 an hour. The lowest 10% earned less than $44,150, and the highest 10% earned more than $108,420, a spread of more than $64,000 that reflects where a given worker falls across the apprentice-to-master progression, license status, industry, and region, not any single factor.',
					'BLS places this occupation against two broader groupings on the same page. Construction trades workers as a whole had a median of $58,150, and the median across all occupations in the economy was $50,980. Plumbers, pipefitters, and steamfitters sit above both comparison figures.',
					'BLS breaks out May 2025 wages by industry into four categories. Government employers, excluding state and local education and hospitals, paid the highest median at $71,660. Manufacturing followed at $65,770, ahead of heavy and civil engineering construction at $63,270. Plumbing, heating, and air-conditioning contractors, the industry that employs the largest share of workers in this occupation, paid the lowest of the four tracked categories, a median of $63,010.',
					],
				},
			{
				heading: 'How to go from apprentice to licensed plumber',
				body: [
					"BLS lists the typical entry-level education for this occupation as a high school diploma or equivalent, with no prior work experience required and on-the-job training delivered through an apprenticeship. After completing an apprenticeship and passing the required licensing exam, workers become journey-level plumbers, pipefitters, or steamfitters, qualified to perform tasks on their own, without direct supervision. Most states, and some localities, require plumbers to be licensed. Although the specifics vary by jurisdiction, BLS notes that states and localities often require 2 to 5 years of experience plus a passing score on an exam testing trade knowledge before allowing a plumber to work independently. BLS directs readers to their state's licensing board for the exact requirements and does not list every state's rules on its own page; this article follows the same approach, since a reader in one state cannot rely on another state's rules.",
					'BLS breaks out where these workers are employed. Plumbing, heating, and air-conditioning contractors employ the largest share, 65%. Self-employed workers make up 8%, and BLS notes self-employed plumbers may be able to set their own schedules. Government employers, excluding state and local education and hospitals, account for 3%, heavy and civil engineering construction for another 3%, and manufacturing for another 3%. After reaching journey level, plumbers with several years of experience can pass a further exam to earn master status, and BLS notes some states require master plumber status specifically to obtain a plumbing contractor\'s license.',
					"For readers comparing this apprenticeship route against other paths that skip a bachelor's degree, [electricians](/electrician-salary/) follow a similarly structured 4- or 5-year apprenticeship starting from the same high school diploma entry bar, and BLS puts their median annual wage at $63,190, within about $600 of the plumbing figure above. [Becoming a CNA](/how-to-become-a-cna/) sits at the other end of the training-length spectrum, a federal minimum of 75 hours rather than a multi-year apprenticeship, and BLS puts the median nursing assistant wage at $42,260, well below either trade. BLS data describes the aggregate labor market for each occupation; it is not a claim that any one of these paths is the better choice for a given person. Another apprenticeship trade, [becoming a lineman](/how-to-become-a-lineman/), is covered separately with its apprenticeship, CDL, and pay details.",
				],
			},
			{
				heading: "Job outlook, and what the growth number does and doesn't mean",
				body: [
					'BLS projects 7% employment growth for plumbers, pipefitters, and steamfitters from 2025 to 2035, which it classifies as much faster than the average for all occupations. That works out to an estimated 34,500 additional jobs and about 42,000 openings a year on average over the decade. As with most occupations BLS tracks, it attributes many of those annual openings to the need to replace workers who transfer to other occupations or leave the labor force entirely, such as to retire, rather than to newly created positions alone.',
					...
					"That 7% figure outpaces the 6% BLS projects for construction trades workers as a whole, though it still trails the 9% BLS projects for [electricians](/how-to-become-an-electrician/), a similarly structured apprenticeship trade covered elsewhere on this site; electricians and plumbers land within about $600 of each other on median pay. BLS does not explain, on this page, why one licensed apprenticeship trade is projected to grow faster than another; the projection describes national demand for the occupation as a whole. It is not a forecast for any specific employer, local union, apprenticeship program, or individual's job security or earnings trajectory, and someone weighing a specific program should look at that program's own placement data and local job market conditions alongside the national figures here.",
				],
			},
		],
		faq: [
			{
				...
				answer: 'Most workers in this trade spend 4 to 5 years in a paid apprenticeship, receiving roughly 2,000 hours of on-the-job work each year alongside classroom coverage of safety rules, local code requirements, and how to read blueprints, according to BLS. Programs come through union halls, trade groups, and individual employers, not one standardized national curriculum.',
			},
			{
				question: 'How much do plumbing apprentices get paid?',
				answer: 'Apprentice pay itself has no separate published BLS figure; the agency only notes that pay is lower during training and increases with added responsibility over the course of the program. What BLS does report is one combined figure for the trade: $63,800 a year ($30.67 an hour) as of May 2025.',
			},
			{
				question: 'What is the difference between a plumber, a pipefitter, and a steamfitter?',
				answer: 'BLS groups all three job titles under a single occupation and pay figure. Plumbers handle water, gas, and drainage systems in homes and businesses, along with fixtures such as toilets and tank heaters. The other two titles cover industrial and manufacturing piping: fitters move liquids, acids, and gases through a facility, while steamfitters handle the high-pressure side of that system.',
			},
			{
				question: 'How do you become a licensed plumber?',
				answer: "A candidate finishes an apprenticeship, then must pass an exam set by the licensing board in their state to reach journey level, which lets them take on jobs unsupervised. Requirements vary by state, but BLS says the typical bar is 2 to 5 years on the job combined with passing a trade-knowledge exam. A further exam, after additional years on the job, leads to master status in states that recognize that tier.",
			},
			{
				question: 'Is plumbing a growing field?',
				answer: 'Yes. BLS expects this occupation to grow 7% between 2025 and 2035, well above the roughly 3% economy-wide average, adding roughly 34,500 jobs over the decade plus about 42,000 average annual openings. Most of those openings come from workers retiring or switching occupations, not newly created jobs. BLS separately flags rising demand for sprinklerfitters tied to fire-suppression building codes.',
			},
		],
		sources: [
			{ label: 'BLS Occupational Outlook Handbook: Plumbers, Pipefitters, and Steamfitters (accessed 2026-09-12 via r.jina.ai reader proxy, direct fetch blocked by Akamai bot detection, data from May 2025, superseding the May 2024 data cited when this page was first published)', url: 'https://www.bls.gov/ooh/construction-and-extraction/plumbers-pipefitters-and-steamfitters.htm' },
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"For readers comparing entry paths that skip a bachelor's degree, truck drivers sit below some of the other trades this site has covered. [Electricians](/electrician-salary/) require a 4- or 5-year apprenticeship and post a higher median of $63,190, while [firefighters](/firefighter-salary/) share the same postsecondary-nondegree-award classification from BLS and post a similar median of $59,280, just above truck drivers. BLS does not track how apprenticeship length, licensing requirements, or industry mix account for the differences between these three occupations.",
				],
			},
			{
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'BLS breaks out May 2025 wages by industry into three categories for this occupation. Specialty trade contractors paid the highest median at $59,440, followed by repair and maintenance at $56,080, then manufacturing at $51,210, the lowest of the three even though manufacturing is by far the largest employer.',
			...
			},
			{
				...
				body: [
					...
					"The certification BLS points to in general terms has a specific, well-documented shape in practice. The American Welding Society runs the AWS Certified Welder (CW) program, widely described by welding schools and trade publications as the credential most working welders pursue. Per AWS's own published program FAQ, it's purely performance-based: a candidate welds to a specific Welding Procedure Specification at an AWS Accredited Test Facility, and the finished weld is judged against the applicable code instead of through a written exam. AWS states there are no prerequisite courses, prior certifications, or minimum years of experience required before testing, and a candidate who doesn't pass on the first attempt can retest with no cap on the number of attempts. The credential doesn't expire outright, but it isn't permanent by default either: AWS requires certification-maintenance paperwork every six months confirming the welder is still actively performing the certified process, and it moves with the worker from employer to employer and state to state.",
					"That's a separate credential from the Certified Welding Inspector (CWI) designation AWS also administers, which qualifies someone to inspect and sign off on other welders' work instead of performing the welds themselves. Where the Certified Welder test is entirely hands-on, the CWI path runs through three separate exam sections, Part A (fundamentals), Part B (a hands-on practical), and Part C (code-book navigation), and AWS requires a minimum score of 72% on each part individually to earn the credential, a figure independently corroborated by third-party CWI exam-prep resources and not just AWS's own page.",
					"Compared with [other no-bachelor's-degree trades](/highest-paying-jobs-without-a-degree/) on this site, welding's entry path is less standardized. [Electricians](/electrician-salary/) typically complete a structured 4- or 5-year apprenticeship and post a higher median of $63,190, about $9,440 above the welder figure. [Plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/) follow a similarly formal apprenticeship model and post an even higher median of $63,800. Welding, by contrast, has several viable entry routes that BLS describes side by side (vocational school, employer apprenticeship, military training, or direct hire with on-the-job training), and BLS does not attribute the pay gap between welding and these other two trades to any one of these training-structure differences. Outside the trades, this site also covers [chef and head cook salary](/chef-salary/) with BLS wage data by percentile.",
				],
			},
			{
				heading: 'Job outlook, and how welding compares to similar occupations',
				body: [
					'BLS projects 2% employment growth for welders, cutters, solderers, and brazers from 2025 to 2035, adding an estimated 10,300 jobs. Despite that limited growth, BLS still projects about 40,300 openings a year on average over the decade, attributing most of them to the need to replace workers who transfer to other occupations or leave the labor force, such as to retire, rather than to newly created positions.',
					...
					'BLS lists eight occupations with similar job duties on the same page, with 2025 median pay ranging from $45,450 for assemblers and fabricators up to $76,410 for boilermakers. Machinists and tool and die makers ($59,620), sheet metal workers ($61,800), and industrial machinery mechanics ($64,100) all post higher medians than welding, while jewelers and precious stone and metal workers ($52,540) and metal and plastic machine workers ($47,700) post lower ones. BLS does not explain what accounts for the spread across this list beyond publishing the figures side by side.',
				],
			},
		],
		faq: [
			{
				...
				answer: 'According to the U.S. Bureau of Labor Statistics, the median annual wage for welders, cutters, solderers, and brazers was $53,750 in May 2025, equivalent to $25.84 an hour. "Median" means half of workers in the occupation earned more and half earned less.',
			},
			{
				question: 'What is the highest-paying industry for welders?',
				answer: 'Among the three industry categories BLS tracks for May 2025, specialty trade contractors paid the highest median at $59,440, ahead of repair and maintenance ($56,080) and manufacturing ($51,210), even though manufacturing employs the largest share of welders at 61%.',
			},
			{
				question: 'How much do the lowest- and highest-paid welders make?',
				answer: 'BLS reports that the bottom 10% of welders, cutters, solderers, and brazers earned less than $39,240 a year in May 2025, while the top 10% earned more than $77,530, a spread of roughly $38,290.',
			},
			{
			...
			{
				question: 'What welding certification do most welders actually get?',
				answer: "BLS doesn't point to one specific credential, but the most common one is the AWS Certified Welder (CW) program, run by the American Welding Society: candidates test their skill directly at an AWS Accredited Test Facility rather than sitting a written exam, with no prerequisite courses or experience required, and the credential stays valid as long as the welder files maintenance paperwork every six months. That's different from the Certified Welding Inspector (CWI) credential, which qualifies someone to inspect welds instead of performing them and requires passing three separate exam sections at a minimum 72% each.",
			},
			{
				question: 'Is welding a growing occupation?',
				answer: 'BLS projects 2% employment growth for welders, cutters, solderers, and brazers from 2025 to 2035, slower than the roughly 3% average across all occupations, adding an estimated 10,300 jobs. Despite the limited growth, BLS still projects about 40,300 openings a year on average, mostly from workers leaving the occupation rather than newly created positions.',
			},
			{
				question: 'Can you make $100,000 a year as a welder?',
				answer: 'Not typically, per national BLS data. The top 10% of welders, cutters, solderers, and brazers earned more than $77,530 a year in May 2025, the highest decile BLS publishes for the occupation, still short of $100,000. Specialty trade contractors, the highest-paying of the three industries BLS tracks for this occupation, had a median of just $59,440. BLS\'s wage data reflects the broad occupation as surveyed nationally; it does not break out highly specialized, higher-hazard niches such as underwater or pipeline welding separately.',
			},
			{
		...
		imageAlt: 'Bar chart showing welder, cutter, solderer, and brazer annual wage by percentile: 10th percentile $39,240, median $53,750, 90th percentile $77,530, based on BLS May 2025 data.',
	},
	{
		...
		sections: [
			{
				...
				body: [
					...
					"BLS describes two other entry paths on the same page. Some employers prefer or require a bachelor's degree, and candidates who already hold one in an unrelated field, commonly social science or business, can add a shorter paralegal studies certificate rather than pursue a second full degree. A third, less common path skips formal paralegal education altogether: BLS notes some employers hire candidates with no legal experience or education, often just a high school diploma, and train them on the job, particularly for specialized practice areas. This site's [social worker guide](/how-to-become-a-social-worker/) covers a related human-services field with its own split entry bar, a bachelor's degree for nonclinical roles or a master's for clinical practice, per BLS.",
					"BLS says paralegal studies programs are typically accredited by professional organizations; there's no one single national accrediting body. One recognized standard is approval by the American Bar Association: NFPA's advanced certification exam, covered below, explicitly accepts degrees from an institutionally accredited and/or ABA-approved paralegal program as one path to eligibility. ABA approval is voluntary for a school and is not required to enter the occupation.",
				],
				image: {
			...
			},
			{
				...
				body: [
					"Unlike some other occupations covered on this site, where a state license is required to work independently, no U.S. state currently licenses the paralegal profession, according to NFPA, the National Federation of Paralegal Associations. NFPA notes several states are working on regulatory frameworks, but as things stand, using the title \"paralegal\" does not require a government-issued license anywhere in the country. That is a sharp contrast with this site's [timeline for becoming a dentist](/how-long-does-it-take-to-become-a-dentist/), which per BLS runs 8 years and ends in mandatory state licensing exams.",
					"That does not mean credentials are absent from the field, only that they are voluntary and come from professional associations, not a government body. The National Association of Legal Assistants (NALA) offers the Certified Paralegal (CP) credential through one of three eligibility routes: completing an ABA-approved or otherwise institutionally accredited paralegal studies program (associate's, bachelor's, or post-baccalaureate certificate, or a program of at least 60 semester hours including 15 hours of substantive legal coursework), holding a bachelor's degree in any field plus at least one year of paralegal experience, or holding a high school diploma plus at least five years of paralegal experience and 20 hours of continuing legal education completed in the two years before applying. Candidates who qualify must pass a three-hour, multiple-choice Knowledge Exam before they are eligible to sit for a separate two-hour, written Skills Exam; passing both is required to earn the CP designation.",
		...
		faq: [
			{
				...
				answer: "Per BLS, most people get their start through a two-year degree or a shorter college-level certificate focused on this field. Alternate paths include finishing a four-year degree in any subject and layering a brief, field-specific certificate on top of it, or, less commonly, entering straight out of high school and learning the job through employer-provided training.",
			},
			{
				question: 'Do paralegals need to be licensed or certified?',
				answer: "According to NFPA, not a single U.S. state has a licensing rule on the books for this occupation. Any credentials that do exist are voluntary and industry-run rather than government-issued: NALA's flagship CP designation and NFPA's PCCE and PACE exams are the two most recognized, and both require passing an exam plus a set number of ongoing legal-education credits to keep the credential active.",
			},
			{
				question: "What's the difference between NALA's CP credential and NFPA's PACE or PCCE exams?",
				answer: "Both are voluntary, not government licenses. NALA's flagship credential, the CP designation, requires passing a Knowledge Exam followed by a Skills Exam. NFPA offers two separate exams: the entry-level PCCE, built for candidates whose schooling shows they're ready even without years on the job and grants the CRP title, and separately the more advanced PACE, which asks for a number of years already working in the field on top of a degree and grants the RP credential instead.",
			},
			{
				question: 'Does flat job growth mean paralegal openings are scarce?',
				answer: 'No. Even with a 2024-to-2034 employment forecast that BLS sums up as essentially flat, the agency still puts yearly openings at around 39,300 on average, mostly turnover as people leave the occupation, not fresh positions being added. BLS separately notes that AI and similar tools may further limit growth by speeding up how quickly paralegals handle research and document work, a more pointed reason than the agency typically volunteers.',
			},
			{
				question: "What is the difference between a paralegal certificate and a paralegal degree?",
				answer: "The two-year degree option is a standalone credential and the most common entry path, per BLS. A paralegal certificate is shorter and typically aimed at people who finished a bachelor's in some other subject and want to bolt on paralegal-specific coursework, such as legal research and writing, so they can skip a second trip through a full undergraduate program.",
			},
			{
				question: 'How long does it take to become a paralegal?',
				answer: 'Most people take the associate-degree route into this field, generally about two years of full-time study, or a shorter certificate program if they already have a four-year degree in a different subject. BLS does not itself state an exact number of years on this page for either path.',
			},
			{
				question: 'What do paralegals get paid?',
				answer: 'The typical paralegal earned $61,010 a year as of BLS\'s May 2024 data. Pay stretched from under $39,710 for the lowest-paid tenth up past $98,990 for the highest-paid tenth.',
			},
		],
		sources: [
		...
		sections: [
			{
				...
				body: [
					"Per BLS, becoming a lawyer usually takes 7 years of full-time study after high school: 4 years of undergraduate study followed by 3 years of law school. Most law schools do not require a specific bachelor's major for admission, though BLS notes that applicants commonly come in having studied law and legal studies, history, or social science. A similar gap between assumed and actual program length shows up in nursing: this site's [guide to nursing school length](/how-long-is-nursing-school/) explains why BLS lists both the BSN and the associate's-degree path at about 4 years, not the 2 years often assumed.",
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"Against other no-bachelor's-degree trades this site has covered, HVAC's 8% growth rate trails the 9% BLS projects for [electricians](/how-to-become-an-electrician/), but comfortably outpaces the 4% BLS projects for [plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/). On pay, HVAC's $59,810 median trails both of those trades, whose medians run in the low $62,000s after a comparably structured multi-year apprenticeship. [Becoming a CNA](/how-to-become-a-cna/) sits at the far end of the training-length spectrum, a federal minimum of 75 hours rather than a postsecondary program or apprenticeship, with a median of $42,260, well below any of the trades above. BLS data describes the aggregate labor market for each occupation; it is not a claim that any one path pays better for a specific person once local demand, certification level, and years of experience are factored in. [What a millwright does](/what-does-a-millwright-do/), another trade this site covers, has its own duties, path, and BLS pay data page.",
				],
			},
		],
		faq: [
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"Against other graduate-credentialed occupations on this site, librarians post a noticeably lower median: [physician assistants](/physician-assistant-salary/), also a master's-degree entry field per BLS, report $133,260, [nurse practitioners](/nurse-practitioner-salary/), likewise master's-level entry per BLS, report $129,210, and [certified registered nurse anesthetists](/crna-salary/), whose accredited programs now award a doctorate rather than the master's degree BLS's summary table still lists, report $223,210, more than triple the librarian figure. BLS does not break down why the gap exists; the comparison describes what BLS's entry-education categories group together, not a claim that any one graduate credential is the better investment for a given reader.",
				],
			},
		],
		faq: [
			{
				...
				answer: "Per BLS, the typical path is about 6 years of full-time study after high school: four years for an undergraduate degree, in whatever subject a student picks, followed by the graduate library credential most employers ask for, which usually runs 1 to 2 years. Anyone aiming for a school library role may follow a different timeline if their state also makes them pick up a teaching license alongside that coursework.",
			},
			{
				question: 'Do you need a master\'s degree to become a librarian?',
				answer: "Usually, yes. Per BLS, this graduate-level library credential is the standard entry ticket for the field, and the ALA's own advice to people entering the field says most employers want a graduate the association has put its stamp of approval on. School library roles are the exception: BLS says those staff can skip the MLS if they instead hold an undergraduate or graduate degree in a connected subject area, paired with whatever teaching license their state issues.",
			},
			{
				question: 'What test do school librarians have to pass?',
				answer: 'It depends on the state. BLS cites an older-named licensing exam that a number of states still mandate; the test publisher, ETS, has since renamed and renumbered it, and now lists it as test code 5312, School Librarian, under its Praxis series. A specific state\'s licensing rule may still cite the older name or code, so a direct call to the state agency that licenses teachers there is the surest way to know which version applies.',
			},
			{
				question: 'How much do librarians make?',
				answer: 'The typical librarian earned $64,320 a year as of BLS\'s May 2024 data, or roughly $30.92 hourly. Pay stretched from under $38,920 for the lowest-paid tenth up past $100,880 for the highest-paid tenth. Pay runs highest, per BLS industry data, in K-12 public schools, $69,880, and lowest among the tracked industries in web search portals, libraries, archives, and other information services, $59,810.',
			},
			{
				question: 'Is librarian a growing career?',
				answer: 'Not by much, per BLS. The 2024-to-2034 outlook calls for a growth rate of just 2%, slower than the average across all occupations, a net gain of roughly 2,400 positions over the decade. That said, the field still churns through something like 13,500 yearly vacancies over that same span, mostly from the need to replace librarians who move to other work or exit the workforce altogether, such as to retire.',
			},
		],
		sources: [
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"Against other advanced-degree occupations this site tracks, the psychologist median trails [physician assistants](/physician-assistant-salary/) at $133,260, [pharmacists](/pharmacist-salary/) at $140,910, and [lawyers](/how-long-does-it-take-to-become-a-lawyer/) at $151,160, occupations whose entry requirements range from a master's degree (PA) to two different professional doctorates (PharmD, J.D.). BLS does not break down why these gaps exist across a mix of master's and doctoral entry paths; the comparison describes what BLS's entry-education categories group together, not a claim that any one degree path is the better investment for a given reader. For a comparison outside healthcare and law, this site also covers the degree, path, and pay for [becoming a software engineer](/how-to-become-a-software-engineer/).",
				],
			},
		],
		faq: [
			{
				...
				answer: "BLS doesn't give a single total-year figure for psychologists the way it does for some other occupations on this site. How long depends on the route: the I-O and school-based routes typically stop at the master's level, which follows four years of undergraduate study, while the clinical route, the biggest group, typically requires a doctorate (Ph.D. or Psy.D.) that includes a required internship and generally takes longer than a master's to complete. Every track then calls for supervised practice hours and passing a licensing exam before someone can see clients on their own, adding more time on top of the degree itself.",
			},
			{
				question: 'Do you need a doctorate to become a psychologist?',
				answer: "Not always. Per BLS, both I-O work and school-based practice allow entry at the master's level. The clinical route, the largest group in the data, usually needs a doctorate, either a Ph.D. or a Psy.D. A few in school settings go for an Ed.S. credential or a doctorate rather than stopping at a master's.",
			},
			{
				question: 'What exam do you need to pass to become a licensed psychologist?',
				answer: "The exam's developer, ASPPB, says each of the 66 jurisdictions across the U.S. and Canada that it covers wants a passing Part 1 (Knowledge) score on the EPPP, the profession's standard licensing exam, prior to licensing, with 500 as the recommended cutoff. A number of jurisdictions add the Part 2 (Skills) portion as well. The Florida board lists the EPPP on its own website too, which matches what ASPPB reports. Requirements beyond the EPPP, such as a state jurisprudence exam, vary by state, so the reliable check is a call or visit to the licensing board in the state where someone plans to work.",
			},
			{
				question: 'How much do psychologists make?',
				answer: "For May 2024, BLS puts typical psychologist pay at $94,310 annually ($45.34 an hour), with the lowest-paid tenth under $54,860 and the highest-paid tenth above $157,330. Pay varies by specialty: I-O psychologists and the \"all other\" category, which covers forensic work and neuropsychology, report the top medians BLS lists, while the school-based specialty, second-largest by employment, posts the lowest at $86,930.",
			},
			{
				question: 'Is psychology a growing career?',
				answer: 'Yes, per BLS: the 2024-to-2034 outlook is 6% growth, ahead of the 3% or so expected for the whole workforce, which works out to about 11,800 added jobs on top of 204,300 today. Yearly openings average near 12,900, and most come from psychologists moving to other work or retiring.',
			},
		],
		sources: [
	...
	},
	{
		...
		description: 'BLS says linemen need only a high school diploma, then apprenticeship training and usually a CDL. Median pay is $95,320 a year, well above other no-degree trades.',
		published: '2026-08-20',
		updated: '2026-09-23',
		socCode: '49-9051',
		coreSummary: "Per the U.S. Bureau of Labor Statistics, electrical power-line installers and repairers (SOC 49-9051) typically need only a high school diploma or equivalent to enter the occupation, building skills through long-term on-the-job training; apprenticeships are common. Two independently reviewed regional apprenticeship sponsors, Southwest Line Constructors and IBEW Local 1186's Hawaii training fund, both describe apprenticeship terms of roughly 7,000 hours of on-the-job training, spanning about three to four years depending on the sponsor, plus related classroom instruction; Southwest Line Constructors also requires a Class A commercial driver's license (CDL) to apply. BLS reports a median annual wage of $95,320 in May 2025, with the bottom 10% earning less than $51,470 and the top 10% earning more than $128,690.",
		sections: [
			{
				...
				body: [
					...
					"Apprenticeships in this trade are sponsored by individual unions, utilities, and contractor associations; there's no single national program setting the terms, so the specific numbers vary by sponsor. Two regional programs reviewed directly for this page, Southwest Line Constructors, which serves apprentices in Arizona, New Mexico, Kansas, Oklahoma, and parts of Texas, and the IBEW Local 1186 training fund in Hawaii, both describe a term of about 7,000 hours of on-the-job training. Southwest Line Constructors states this term \"may require more than three and one half years to complete in view of possible employment lapses,\" plus three years of related classroom instruction away from the job. The Hawaii program describes essentially the same 7,000-hour on-the-job total as running \"approximately 3 years,\" supplemented by 480 hours of related classroom instruction. The two sponsors land on similar on-the-job hour totals but different stated timelines and classroom-hour figures, a real difference in how each program structures and counts the work, not a mistake in either one.",
				...
				image: {
					...
					alt: 'Diagram showing the path to becoming a lineman: a high school diploma, meeting apprenticeship requirements including a commercial driver\'s license, roughly 7,000 hours of paid on-the-job apprenticeship training, and journeyman status, with a median pay of $95,320 a year per BLS.',
				},
			},
			{
			...
			},
			{
				...
				body: [
					"BLS reports a median annual wage of $95,320 for electrical power-line installers and repairers in May 2025, or $45.83 an hour, well above the $50,980 median across all occupations that year. The bottom 10% earned less than $51,470, and the top 10% earned more than $128,690, a spread of more than $77,000, or more than 2.5 times, between the boundary figures BLS publishes.",
					"By industry, BLS breaks out May 2025 wages into five categories. Federal government employers paid the highest median at $111,900, followed by utilities at $103,060, local government excluding education and hospitals at $90,060, specialty trade contractors at $76,980, and utility system construction, the lowest of the five tracked categories, at $76,060. BLS does not explain what drives that industry ordering, though whether the employer is a federal agency or utility directly operating the grid, or a contractor building or maintaining it under contract, is one plausible distinction worth confirming against a specific job offer, not assumed from the industry label alone.",
				],
			},
			{
				heading: 'Job outlook, and how this pay compares with other no-degree trades on this site',
				body: [
					"BLS projects employment of electrical power-line installers and repairers to grow 10% from 2025 to 2035, a rate it classifies as much faster than the average for all occupations, adding an estimated 13,600 jobs to the 131,900 already employed in 2025. About 10,900 openings are projected each year on average over the decade, though BLS attributes many of those to the need to replace workers who transfer to other occupations or exit the labor force, such as to retire, rather than to newly created positions alone.",
					"Against other no-degree, apprenticeship-based trades this site tracks, all of which BLS also lists as requiring only a high school diploma or equivalent to enter, the lineman median sits well above [electricians](/electrician-salary/) at $63,190, [plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/) at $63,800, and [welders, cutters, solderers, and brazers](/welder-salary/) at $53,750, a gap of more than $31,000 in every comparison and above $41,000 against welders specifically. BLS does not state why line work pays more within this cluster of similarly credentialed occupations, and the page's Similar Occupations table lists power plant operators, distributors, and dispatchers, another high school diploma occupation, at a comparably high $103,600 median, while electricians on the same table sit far closer to welders and plumbers than to either line work or power plant operations. That comparison table is consistent with the two occupations that carry the clearest physical exposure to high-voltage electricity commanding the highest pay in the group, but BLS's data describes what employers pay, not why, and this page reports the pattern without claiming a specific cause. [Millwrights](/what-does-a-millwright-do/), another trade this site covers, have their own duties, path, and BLS pay data page.",
				],
			},
		],
		faq: [
			{
				...
				answer: "BLS says a standard high-school credential is all it takes to get in the door. The apprenticeship itself, where most people build the skills to work independently, runs on a sponsor-by-sponsor basis; a pair of regional sponsors checked for this article each land on roughly 7,000 on-the-job hours, with one citing about three and a half years and the other about three years, plus extra hours of related coursework off the job that also differ by sponsor.",
			},
			{
				question: 'Do you need a CDL to become a lineman?',
				answer: "Usually, though it's whichever organization runs the training program that sets the exact requirement, not BLS or any single national rule. The Southwest regional sponsor covered elsewhere on this page won't accept an application without a Class A CDL in hand, while the Hawaii-based sponsor wants applicants who already hold an ordinary driving license and can clear the medical exam that comes with getting a CDL, without naming which CDL class applies. The reliable move is to check the exact rule directly with whichever sponsor is the target.",
			},
			{
				question: 'How much do linemen make?',
				answer: 'The typical lineman took home $95,320 a year as of BLS\'s May 2025 release, close to $45.83 hourly. Pay ranged from under $51,470 at the low end of the scale to more than $128,690 at the top. Uncle Sam and the utility companies themselves paid the most, $111,900 and $103,060 respectively, while the firms BLS classifies under construction of utility systems paid the least of the five industries tracked, at $76,060.',
			},
			{
				question: 'Is lineman a growing career?',
				answer: 'Yes. The 2025-to-2035 forecast calls for 10% growth in this occupation, a pace BLS puts well ahead of the typical job, tacking on about 13,600 positions to a 2025 workforce of 131,900. On a yearly basis, roughly 10,900 job openings are expected on average, and BLS pins most of that yearly figure on people leaving for other work or retiring, not on the field expanding.',
			},
			{
		...
		imageAlt: 'Diagram showing the path to becoming a lineman: a high school diploma, meeting apprenticeship requirements including a commercial driver\'s license, roughly 7,000 hours of paid on-the-job apprenticeship training, and journeyman status, with a median pay of $95,320 a year per BLS.',
	},
	{
		...
		sections: [
			{
				...
				body: [
					'BLS tracks this occupation under the combined title "Chefs and Head Cooks," SOC code 35-1011, describing the work as overseeing the daily food preparation at restaurants and other places where food is served. The median annual wage was $60,990 in May 2024 ($29.32 an hour), above the $49,500 median across all occupations in the U.S. economy that year. The bottom 10% of chefs and head cooks earned less than $36,000, and the top 10% earned more than $96,030, a spread of well over two and a half times between the lower and upper bound BLS reports. For a healthcare role with a comparable median but a formal bachelor\'s-degree entry bar instead of years of food-service experience, see this site\'s [clinical lab technologist pay](/clinical-laboratory-technologist-salary/) guide.',
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"A milder version of that pattern shows up elsewhere on this site: for [chefs and head cooks](/chef-salary/), food services and drinking places, their largest employer, pays less than smaller segments like traveler accommodation, though healthcare and social assistance is lower still among the four industries BLS lists. BLS's industry breakdown describes where the pay is higher or lower; it does not explain why the biggest employer in a field is rarely also the highest payer, and this page does not assert a cause beyond what BLS itself reports.",
				],
			},
			{
		...
		faq: [
			{
				...
				answer: "Per BLS, the typical entry path is four years of college studying computing or an adjacent subject, which matches most degree-entry jobs. Unlike some licensed trades and professions, BLS names no licensing step, exam, or certification period after the degree, so there is no extra multi-year credentialing stage built into the typical path the way there is for, say, a CPA license or an actuarial exam series.",
			},
			{
				question: 'Do you need a coding bootcamp or certification to become a software developer?',
				answer: "The BLS profile for this role names a four-year degree as the requirement and says only that a master's is favored by certain employers when hiring developers. It does not list a bootcamp, certification, or any other credential as a requirement. This page reports what BLS states as the typical path; it does not evaluate whether a bootcamp or certification helps in practice; that is outside the scope of the data this site tracks.",
			},
			{
				question: 'Is a software engineer the same thing as a software developer?',
				answer: 'Per O*NET, the Labor Department\'s job-title database, the title Software Engineer appears among the example titles filed under SOC 15-1252.00, the code BLS applies to this whole occupation, next to titles like Software Architect and DevOps Engineer. The two titles describe the same underlying occupation in BLS and O*NET\'s own classification, not two separate ones.',
			},
			{
				question: 'How much do software developers make?',
				answer: 'Median pay came to $133,080 a year in May 2024, according to BLS, with the range running from under $79,850 at the bottom 10% to over $211,450 at the top 10%. By industry, firms that publish software led at $149,990, while the computer-systems-design industry, which employs the biggest share of developers, paid the least of the five it reports, at $129,890.',
			},
			{
				question: 'Is software development a growing career?',
				answer: "Yes, according to BLS's occupation-level projections table, which splits the Handbook's combined 15% growth figure by job. For developers alone the projection is 15.8% growth over the 2024-2034 decade, adding an estimated 267,700 jobs to the roughly 1,693,800 already working in 2024, both figures BLS itself classifies as much faster than the roughly 3% average projected across all occupations.",
			},
			{
				question: 'Can software developers make $300,000 a year?',
				answer: 'BLS\'s own wage data tops out below that figure: the top-paid tenth of developers made over $211,450 as of May 2024, the top percentile BLS reports for the occupation. BLS\'s Occupational Employment and Wage Statistics survey measures cash wages reported by employers; it does not capture total compensation packages that include equity or stock awards, which some large technology employers add on top of base pay and which are not reflected in this figure.',
			},
		],
		sources: [
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"Professional certification is not required to work as a controller, per BLS, though it can indicate competence to employers. BLS points to CareerOneStop, a U.S. Department of Labor resource, for details on specific certifications available to financial managers with government-focused work; separately, some controllers hold a Certified Public Accountant (CPA) license, which BLS notes is issued by state boards of accountancy after a candidate passes an exam. From there, BLS lists a specific advancement path: experienced financial managers, controllers included, may advance to become chief financial officers (CFOs), the executives BLS describes as responsible for the accuracy of an organization's overall financial reporting, a level above the department-specific reporting a controller oversees. This site's guide to [what a CEO does](/what-does-a-ceo-do/) covers the top executive role's duties, pay, and job outlook.",
				],
			},
			{
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					"Against another postsecondary-certificate occupation this site tracks, the court reporter median sits well below [ultrasound techs](/how-to-become-an-ultrasound-tech/) at $89,340, even though both start from a similar credential tier, roughly two years of postsecondary training for ultrasound techs against 2 to 3 years for court reporters. BLS's data describes what each occupation pays; it does not explain the roughly $22,000 gap between two occupations built on a comparable level of postsecondary training.",
				],
			},
			{
		...
		faq: [
			{
				...
				answer: 'Per BLS, finishing the after-high-school training path for this field usually runs 2 to 3 years, done at a two-year school or vocational training center. After that, most states require passing a licensing or certification exam that covers both written knowledge and hands-on typing, recording, or transcription speed and accuracy, before a graduate can take a job at a courthouse or similar legal venue. BLS doesn\'t list any prior related work experience as a requirement for entry-level hires, though newly licensed reporters still spend some time building real-world speed on the job, and how long that takes shifts depending on whether the worker specializes in shorthand-machine work, speech-to-text dictation, or computer-based transcription methods.',
			},
			{
				question: 'Do you need a license to be a court reporter?',
				answer: "Often, yes. Per BLS, most states set their own bar for legal-setting work in this field, typically some combination of official state approval and a licensing test run by a trade association, though the specifics shift depending on location and on which reporting method a worker uses. Paralegals face a different rule: [paralegals](/how-to-become-a-paralegal/) also train through a comparably short postsecondary credential, but BLS notes that occupation currently has zero state licensing requirements anywhere in the country.",
			},
			{
				question: 'How much do court reporters make?',
				answer: 'Workers in this field earned a median $67,310 a year as of BLS\'s May 2024 release, roughly $32.36 hourly. Reporters in the lowest tenth of the pay scale brought home under $39,100, and those in the highest tenth topped $127,020. Local government offered the strongest pay among the three industries BLS tracks separately, a $75,150 median, state government wasn\'t far off at $74,660, and contract reporting firms, what BLS files under the business-support-services category, paid the least, at $51,290.',
			},
			{
				question: 'Is court reporting a growing career?',
				answer: 'Growth-wise, no. BLS projects essentially flat headcount for this field, a net change of zero jobs between 2024 and 2034. Hiring doesn\'t stop just because headcount holds steady, though: an estimated 1,700 positions open up each year, on average, almost all of them created when someone already in the role moves on to another trade or steps out of the workforce entirely, say for retirement, rather than by the field adding new positions overall.',
			},
			{
	...
	},
	{
		...
		description: 'Millwrights install, dismantle, and move industrial machinery. BLS puts their median pay at $65,700 and projects just 1% job growth through 2035.',
		published: '2026-08-23',
		updated: '2026-09-23',
		socCode: '49-9044',
		coreSummary: "Per the U.S. Bureau of Labor Statistics, millwrights install, dismantle, repair, reassemble, and move industrial machinery in factories, power plants, and construction sites. BLS tracks the role inside a combined occupation, Industrial Machinery Mechanics, Machinery Maintenance Workers, and Millwrights, but unlike some combined-title occupations this site covers, it does publish a millwright-specific median wage: $65,700 a year in May 2025, above the $64,520 median for industrial machinery mechanics and the $60,850 median for machinery maintenance workers in the same group. Most millwrights enter through a 3- to 4-year apprenticeship rather than a college degree. BLS projects just 1% employment growth for millwrights specifically from 2025 to 2035, a rate that still falls into the \"little or no change\" band on BLS's own growth-rate classification scale, even though the broader group they're tracked alongside is projected to grow 14%.",
		sections: [
			{
			...
			},
			{
				...
				body: [
					...
					"That apprenticeship structure puts millwrights in the middle of the [no-degree trades this site tracks](/highest-paying-jobs-without-a-degree/). It runs a year shorter than the [plumbing apprenticeship](/plumbing-apprenticeship/), which this site's BLS-sourced data puts at 4 to 5 years with roughly 2,000 paid hours a year, and shorter than the 4- or 5-year apprenticeship BLS describes for [electricians](/electrician-salary/), which likewise runs about 2,000 paid hours per year. It's also more structured than the path into [welding](/welder-salary/), where BLS describes several viable entry routes side by side (vocational school, employer apprenticeship, military training, or direct hire with on-the-job training) rather than one standard apprenticeship length. For the day-to-day duties on the welding side, see [what a welder does](/what-does-a-welder-do/).",
				],
			},
			{
				heading: 'Pay: a millwright-specific figure inside a combined BLS page',
				body: [
					'BLS reports a median annual wage of $64,100 for the combined group, Industrial Machinery Mechanics, Machinery Maintenance Workers, and Millwrights, in May 2025. Inside that combined figure, BLS breaks median pay out by the three individual titles: millwrights earned a median of $65,700, above industrial machinery mechanics at $64,520 and machinery maintenance workers at $60,850. What BLS does not break out by title is the 10th and 90th percentile range or the industry-by-industry wage table. For the combined group as a whole, the bottom 10% earned less than $45,760 and the top 10% earned more than $94,530, a spread of roughly 2 times between the two boundary figures, but that range describes all three titles together, not millwrights specifically. The same caveat applies to the industry breakdown: manufacturing paid the highest median for the combined group at $65,220, followed by construction at $63,870, wholesale trade at $62,450, and the commercial-and-industrial-machinery repair-and-maintenance industry at $60,780, again without a millwright-only figure inside each industry.',
					'Against other no-degree apprenticeship trades this site tracks, the millwright median lands just above [electricians](/electrician-salary/) at $63,190 and [plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/) at $63,800, and well above [welders, cutters, solderers, and brazers](/welder-salary/) at $53,750, a gap of nearly $12,000 against welders specifically. BLS\'s data describes what each occupation pays; it does not explain why the shorter millwright apprenticeship pairs with pay above two trades that require a longer one, and this page reports the pattern rather than asserting a specific cause. This site\'s [how to become a lineman](/how-to-become-a-lineman/) guide covers the apprenticeship, CDL, and pay for a further trade in this group.',
				],
			},
			{
				heading: 'Job outlook: nearly flat for millwrights, even as the wider group grows',
				body: [
					'BLS projects overall employment for the combined group, industrial machinery mechanics, machinery maintenance workers, and millwrights, to grow 14% from 2025 to 2035, much faster than the roughly 3% average across all occupations, with about 51,900 openings projected each year on average across the whole group. Millwrights specifically do not share in that growth. BLS\'s own projections table shows millwright employment ticking up only slightly, from 40,700 jobs in 2025 to a projected 41,000 in 2035, a rounded 1% change that still falls into the "little or no change" band on BLS\'s growth-rate classification scale (an increase of less than 1% to a decrease of less than 1%), out of 40,700 millwrights within the larger 547,300-person combined workforce. Industrial machinery mechanics, the largest of the three titles at 446,900 workers, account for nearly all of the group\'s projected growth, up 18% to 526,600; machinery maintenance workers are projected to shrink 2%, to 58,600.',
					'BLS attributes the flat millwright number to the specific industries that employ them. Millwrights\' employment, per BLS, "is affected by the slower growth of the industries in which they are employed, such as paper mills." BLS also points to slower expected job growth in nonresidential construction, since the facilities built there are less likely to require a millwright, as a second drag on the number. That combined-group total of 51,900 annual openings is not broken out by title either, so this page does not attribute a specific annual-openings figure to millwrights alone. For context on what drives growth elsewhere in the group, BLS credits continued adoption of automated manufacturing machinery and expanded use of automated conveyors, both of which need regular upkeep, with creating jobs for industrial machinery mechanics specifically.',
				],
			},
		],
		faq: [
			...
			},
			{
				...
				answer: "BLS reports a median annual wage of $65,700 for millwrights in May 2025, a figure it breaks out specifically for the title within the combined Industrial Machinery Mechanics, Machinery Maintenance Workers, and Millwrights group. That's above the $64,520 median for industrial machinery mechanics and the $60,850 median for machinery maintenance workers in the same group. BLS does not publish 10th and 90th percentile wages or an industry-by-industry breakdown specific to millwrights; those figures, $45,760 to $94,530 by percentile and $60,780 to $65,220 by industry, cover all three titles combined.",
			},
			{
			...
			},
			{
				...
				answer: 'Barely, by BLS\'s growth measure. While the broader group millwrights are tracked within, industrial machinery mechanics, machinery maintenance workers, and millwrights, is projected to grow 14% from 2025 to 2035, BLS\'s own projections table shows millwright employment specifically ticking up only from 40,700 to a projected 41,000 jobs across that same decade, a rounded 1% change that still falls into the "little or no change" band on BLS\'s growth-rate classification scale. BLS attributes the near-flat number to slower growth in the industries that employ millwrights, such as paper mills, and to slower expected job growth in nonresidential construction.',
			},
			{
		...
		sources: [
			{ label: 'BLS Occupational Outlook Handbook: Industrial Machinery Mechanics, Machinery Maintenance Workers, and Millwrights (data from May 2025, synced 2026-09-23 via direct curl fetch with a UA string carrying a declared contact URL, returned 200, superseding the May 2024 figures cited when this page was first published)', url: 'https://www.bls.gov/ooh/installation-maintenance-and-repair/industrial-machinery-mechanics-and-maintenance-workers-and-millwrights.htm' },
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Among other occupations this site has covered, paramedic pay sits close to [firefighters](/firefighter-salary/), which BLS also classifies under a "postsecondary nondegree award" entry-level education and whose $59,280 median is about $870 above the paramedic figure. It sits well above [CNAs](/how-to-become-a-cna/), whose $42,260 median is roughly 28% lower, even though CNA training runs a federal floor of just 75 hours and involves no multi-tier certification path. BLS does not weigh how much of these gaps traces to training length, scope of practice, or the settings each occupation typically works in.',
				],
			},
			{
				heading: 'Job outlook, and an advancement path BLS names specifically',
				body: [
					'BLS projects 5% employment growth for the combined EMT-and-paramedic occupation from 2024 to 2034, a rate it classifies as faster than the roughly 3% average across all occupations, with about 19,000 openings projected each year on average over the decade. As with most occupations BLS tracks, it attributes many of those annual openings to the need to replace workers who transfer to a different occupation or exit the labor force, such as to retire, so new positions account for only part of the total. That 5% figure and the 19,000-opening estimate cover EMTs and paramedics together; BLS does not publish a paramedic-specific growth rate or opening count on this page.',
		...
		faq: [
			{
				...
				answer: 'Per BLS, the path has three stages: EMT-Basic (typically under a year), then EMT-Intermediate (up to 2 years), and finally the paramedic course of study, which you cannot enter without the intermediate credential and which ends in a nondegree award, a two-year degree, or in some cases a bachelor\'s. Prior EMT work experience is also normally expected before admissions will take you, on top of the coursework itself.',
			},
			{
				question: 'How much do paramedics make?',
				answer: 'Paramedics earned a median of $58,410 a year as of May 2024 per BLS, against $41,340 for EMTs and $46,350 when the two are pooled. By industry, local government employers (schools and hospitals excluded) pay paramedics the most at the median, $59,840, with physician offices next at $59,370. BLS publishes no 10th- or 90th-percentile wage figures for paramedics.',
			},
			{
				question: "What's the difference between an EMT and a paramedic?",
				answer: 'BLS tracks them as separate occupations: paramedics have their own SOC code, 29-2043, apart from the 29-2042 code assigned to EMTs, though both fall under one umbrella Handbook page. Paramedics complete additional certification beyond EMT-Intermediate, including a dedicated college-level program covering EKG interpretation and airway management, and BLS reports a meaningfully higher median wage for paramedics: $58,410 versus $41,340 for EMTs in May 2024.',
			},
			{
				question: 'Do paramedics need a license?',
				answer: 'Yes. BLS says every state licenses both roles, though the exact process varies: most have candidates sit a certifying test, and others accept a comparable exam run by the state. States can add conditions like an age floor or a background screening, and CareerOneStop is the source BLS points to for state-specific licensing board details.',
			},
			{
				question: 'Is paramedic a growing career?',
				answer: 'By BLS\'s growth measure, yes, though the figure pools EMTs with paramedics rather than isolating paramedics. Projected growth is 5% for 2024 to 2034, ahead of the 3% or so BLS expects for the workforce as a whole, and the agency counts about 19,000 yearly openings, most of them replacements for people who exit the field.',
			},
		],
		sources: [
	...
	},
	{
		...
		faq: [
			...
			{
				question: 'Is bookkeeping a hard job?',
				answer: "Not in the way some licensed occupations on this site are. There's no state license, certifying exam, or four-year degree standing between someone and this job, per BLS, only a general preference for a bit of college beyond finishing high school. Nearly everything else a new hire needs to know gets learned while doing the work itself. The harder part may be job security: BLS expects the workforce here to get smaller, not bigger, as software takes over more of the work.",
			},
		],
		sources: [
	...
	},
	{
		...
		description: "Welders read blueprints, then join or cut metal by hand under intense heat and light. BLS's median pay for the role is $53,750, with real burn and injury risk.",
		published: '2026-08-25',
		updated: '2026-09-23',
		socCode: '51-4121',
		coreSummary: "Per the U.S. Bureau of Labor Statistics, welders, cutters, solderers, and brazers use hand-held or remotely controlled equipment to join, repair, or cut metal parts, reading blueprints, measuring dimensions, and monitoring heat as they work. BLS tracks the four roles under one SOC code, 51-4121, and reports a median annual wage of $53,750 in May 2025. The work carries real physical risk: BLS specifically flags fumes, very hot materials, and intense arc light among the job's hazards, and most workers need only a high school diploma plus technical and on-the-job training to enter.",
		sections: [
			{
			...
			},
			{
				...
				body: [
					"BLS reports a median annual wage of $53,750 for welders, cutters, solderers, and brazers in May 2025 ($25.84 an hour), with the bottom 10% earning less than $39,240 and the top 10% earning more than $77,530. Manufacturing employs the largest share of the occupation at 61%, though it pays the lowest of the three industry medians BLS tracks, behind specialty trade contractors and repair and maintenance. BLS projects 2% employment growth from 2025 to 2035, slower than the roughly 3% average across all occupations, though about 40,300 openings are still projected each year, mostly from workers leaving the occupation rather than newly created positions. For [the full percentile breakdown](/welder-salary/), covering the industry pay table and an entry-path comparison against other no-degree trades such as [electricians](/electrician-salary/) and [plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/), see this site's welder pay page.",
					'Per BLS, welders typically need only a high school diploma or equivalent, combined with technical and on-the-job training, to enter the occupation, with no postsecondary degree required. That distinguishes the entry path from several other skilled trades this site tracks, which more often run through a multi-year formal apprenticeship before a worker reaches full pay. [What a millwright does](/what-does-a-millwright-do/), for example, is covered on its own page with duties, path, and BLS pay data.',
				],
			},
		],
		faq: [
			{
				...
				answer: 'Per BLS, a welder\'s day runs through studying job specs and drawings, checking over the pieces before joining them, running the actual weld while keeping heat under control, then cleaning and maintaining the equipment afterward. The choice of process, arc welding among them, usually comes down to factors like which metals are being joined.',
			},
			{
				question: "What's the difference between a welder, cutter, solderer, and brazer?",
				answer: 'BLS tracks all four together in its data, sorting them apart by what each one physically does rather than any pay distinction. Welders bond metal through methods like arc welding, running a current through the joint to generate melting heat. Cutters rely on an electric arc, plasma, or an open flame to slice and shape metal pieces, including taking apart large structures. The other two share a filler-metal approach, fusing pieces with heated filler rather than melting the base metal itself, but at different temperatures and for different jobs. Soldering runs cooler and suits small, precise work, while brazing works across metals of different types and can leave behind a wear-resistant coating.',
			},
			{
				question: 'Is welding a dangerous job?',
				answer: "BLS is direct about it: this occupation carries real injury risk, pointing to airborne fumes, extreme heat, and the arc's blinding glare as job-specific risks. The countermeasures are procedural and physical: sticking to safety protocols and wearing gear like a welding helmet, ear protection, and gloves rated for heat. Some assignments also add work at height, heavy lifting, or twisting into cramped body positions to the mix.",
			},
			{
				question: 'How much do welders make?',
				answer: "For May 2025, BLS puts pay at a $53,750 median annually, or $25.84 an hour, ranging from under $39,240 at the 10th percentile up to $77,530 at the 90th. That spread, plus a breakdown by industry, lives on this site's dedicated wage guide for the role.",
			},
			{
				question: 'Do welders work regular hours?',
				answer: "Most are on full-time schedules, with some clocking over 40 hours a week, according to BLS. A lot of manufacturing plants run 8- to 12-hour shifts, two or three per day, so the line never really stops, and evenings and weekends come with the territory even before counting overtime.",
			},
			{
				question: 'Do welders make a lot of money?',
				answer: 'Not especially, relative to the broader U.S. labor market. BLS\'s May 2025 figure for this occupation, $53,750, sits just above the $50,980 median it reports economy-wide for that same year. See this site\'s [welder pay breakdown](/welder-salary/) for the complete wage-by-percentile and industry picture.',
			},
			{
				question: 'Is welding a hard job?',
				answer: "Physically and technically, yes, on the demands BLS itself describes. The work calls for close, sustained attention (adjusting heat on the fly while working to spec), real physical strain (hauling heavy pieces, reaching overhead or twisting into cramped postures, sometimes working at height on temporary rigging), and genuine on-the-job hazards from smoke, punishing heat, and the arc's own glare. Add in round-the-clock manufacturing shift patterns, and evening or weekend work becomes routine rather than an exception. It's a skilled trade with a relatively fast, low-cost entry path, but BLS's own description of the job doesn't paint it as easy once someone is actually doing it.",
			},
			{
				question: 'Why do welders not live long?',
				answer: "BLS doesn't publish life-expectancy or mortality data for any occupation, and this page isn't aware of a rigorous, welder-specific study that puts a number on it. What is well documented is the occupational exposure behind that reputation. Welding fume particles small enough to reach deep into the lungs can cause fibrosis, or scarring, that can develop into lung cancer, and welding on stainless steel and other chromium-containing alloys can expose workers to hexavalent chromium, which OSHA identifies as carcinogenic and linked to effects on the respiratory system, kidneys, liver, skin, and eyes. Manganese in welding fume has also been linked to neurological damage at low exposure levels. Modern fume-extraction equipment and respiratory protection substantially cut down these exposures versus unprotected work, and safety gear plus following protocol is how BLS says the occupation's injury risk gets managed day to day, but the underlying health hazards are real and specific, not just a reputation.",
			},
			{
				question: 'Can you make $100,000 as a welder?',
				answer: "Not typically, per national BLS data. The 90th-percentile figure BLS publishes for the combined group, $77,530 in May 2025, is the highest bracket it reports, well short of $100,000. Reaching that level would generally mean combining top-decile pay with a higher-paying specialty, employer, or region than the national wage data captures; see this site's [welder wage guide](/welder-salary/) for the fuller breakdown.",
			},
		],
		sources: [
			{ label: 'BLS Occupational Outlook Handbook: Welders, Cutters, Solderers, and Brazers (data from May 2025, synced 2026-09-23 via direct curl fetch with a UA string carrying a declared contact URL, returned 200, superseding the May 2024 figures cited when this page was first published)', url: 'https://www.bls.gov/ooh/production/welders-cutters-solderers-and-brazers.htm' },
		...
		faq: [
			{
				...
				answer: "There's no fixed timeline BLS publishes, but the sequence is: meet an airline's eligibility screening (education, experience, background check), get hired, then spend a stretch of weeks or a couple of months in employer-provided initial training, after which the FAA signs off on the federal credential required to work the job.",
			},
			{
				question: 'Do you need a college degree to be a flight attendant?',
				answer: 'No. A high school education, or its equivalent, is what BLS lists as the standard credential airlines look for, though some carriers favor applicants who\'ve taken college classes or hold a degree, and working overseas routes can mean needing to speak a second language well.',
			},
			{
			...
			},
			{
				...
				answer: "Yes, for most commercial flights. Anyone crewing the cabin on a plane seating 20 passengers or more must carry FAA sign-off proving they finished the required training, a federal rule Congress wrote into law in 2003 and that airlines have had to follow since Dec. 11, 2004. That credential is issued only once someone finishes their airline's own training program, one the FAA has signed off on in advance.",
			},
			{
				question: 'How much do flight attendants make?',
				answer: "The BLS figure for May 2025 puts the typical flight attendant at $63,580 a year, but that single number masks a wide spread: the bottom tenth earned under $35,110, while the top tenth cleared $136,430, gaps driven largely by seniority. See [this site's pay breakdown for the role](/how-much-do-flight-attendants-make/) for the full percentile and industry detail.",
			},
			{
				question: 'Do flight attendants get paid well?',
				answer: 'About average for the broader U.S. labor market. BLS puts median pay for this role at $63,580 for May 2025, above the $50,980 median BLS reports across all U.S. occupations that same year, though pay varies by airline type; see this site\'s [breakdown of flight attendant pay](/how-much-do-flight-attendants-make/) for the full percentile breakdown.',
			},
			{
				question: 'What is the 35-7 rule for flight attendants?',
				answer: "That's not an FAA safety regulation; it's a scheduling limit built into union contracts. Under the collective bargaining agreements at American Airlines (APFA) and United (AFA-CWA), for example, airlines can't schedule someone working reserve for more than 35 hours of flying in any seven consecutive 24-hour stretch on domestic routes, and reserves don't have to accept a schedule that pushes past that cap. The exact numbers vary by carrier and by whether the person holds a reserve slot or a bid line, since this comes from each airline's own labor contract rather than a nationwide rule BLS or the FAA publishes.",
			},
		],
		sources: [
		...
		faq: [
			{
				...
				answer: "Per BLS, day-to-day duties include reviewing a patient's health background, conducting exams, ordering and reading diagnostic results, working out a diagnosis, and prescribing treatment, usually within one population focus, like caring for adults and the elderly, treating children, or handling mental and behavioral health. NPs also spend time explaining care plans to patients and coordinating with the rest of a patient's care team.",
			},
			{
				question: "What's the difference between a nurse practitioner and a registered nurse?",
				answer: "BLS draws the line by noting NPs and RNs overlap on basic duties, like assessing a patient's status and responding to it, but NPs go further: they're trained to order and evaluate test results, route people to the right specialist, and put together a diagnosis and treatment plan, tasks outside a registered nurse's scope.",
			},
			{
				question: 'Can nurse practitioners practice without a supervising physician?',
				answer: "There's no fixed national answer; it comes down to which state someone practices in. See this site's [NP salary and scope-of-practice guide](/nurse-practitioner-salary/) for how the state categories break down, and confirm current rules for any one state directly through that resource.",
			},
			{
				question: 'Do nurse practitioners specialize?',
				answer: 'Yes. Per BLS, most NPs concentrate on one population group, such as adults and older patients, children, or people needing mental and behavioral healthcare, which shapes the day-to-day mix of conditions and patients any one practitioner sees.',
			},
			{
				question: 'How much do nurse practitioners make?',
				answer: "BLS's May 2024 figure puts this role's pay at $129,210 a year. See [NP pay data](/nurse-practitioner-salary/) for the full wage and job-outlook breakdown.",
			},
			{
				question: 'How many years of school does it take to become a nurse practitioner?',
				answer: 'BLS doesn\'t spell out one single combined total on this page either; it describes the requirement as at least a master\'s degree in an advanced practice nursing specialty, built on top of an existing RN license, with most programs preferring candidates who already hold a bachelor\'s degree in nursing. Based on typical program lengths, a four-year undergraduate degree followed by a master\'s- or doctoral-level NP program, sources outside BLS commonly put the full path at roughly six to eight years, though the exact timeline depends on the school and whether a candidate already has RN experience.',
			},
			{
				question: 'What is the highest paid nurse practitioner?',
				answer: "BLS doesn't say. It keeps this a single national figure, $129,210 for May 2024, and skips a wage breakdown by population focus such as family care, mental and behavioral health, or acute care. Several nursing-industry and job-board sites report the mental-health and acute-care tracks among the higher-paid ones, but those figures come from self-reported salary surveys rather than BLS's employer-reported data, and different sites report different dollar amounts for the same specialty. See this site's [NP wage breakdown](/nurse-practitioner-salary/) for the full picture.",
			},
			{
				question: 'Is an RN higher than a nurse practitioner?',
				answer: 'No, it works the other way. This advanced-practice role is built on top of the RN credential: someone must already be a licensed registered nurse before completing the additional graduate education BLS lists as the typical entry-level requirement. That added training brings a broader scope of practice, such as diagnosing conditions and prescribing medication, that a base RN license does not include on its own.',
			},
		],
		sources: [
	...
	},
	{
		...
		sections: [
			{
				...
				body: [
					...
					"BLS lists a master's degree in occupational therapy as the typical entry-level education for this occupation, a graduate credential rather than a bachelor's or associate's degree. That places it in the same broad tier as several other rehabilitation and diagnostic professions this site tracks, though the exact credential level still varies by field: [physical therapists](/physical-therapist-salary/) need a Doctor of Physical Therapy, one step above a master's, while occupational therapy has not made that same shift to doctoral-entry education as its typical path. For another allied-health comparison, this site's [respiratory therapist salary](/respiratory-therapist-salary/) guide reports BLS wage data by percentile for that field. This site's [occupational therapy assistant salary](/occupational-therapy-assistant-salary/) guide covers the assistant-level role's BLS pay separately.",
		...
		faq: [
			...
			{
				question: 'How long does it take to become an occupational therapist?',
				answer: "Typically six to seven years altogether, per BLS: a four-year bachelor's degree first, since these graduate programs require one for admission, followed by a two- to three-year program pairing science coursework with supervised client fieldwork. After finishing that fieldwork, a graduate still has to clear a licensing exam before being allowed to practice.",
			},
			{
				question: 'Is OT harder than nursing?',
				answer: "BLS doesn't rate occupations by difficulty, but the credentialing timelines differ. The OT path runs through four years of undergraduate study plus a two- to three-year master's program, roughly six to seven years altogether, followed by a licensing exam. Registered nursing moves faster in most cases: per this site's [how long is nursing school](/how-long-is-nursing-school/) guide, BLS lists both the bachelor's (BSN) and associate's (ADN/ASN) nursing paths at about four years to completion, a shorter timeline than the track above.",
			},
		],
		sources: [
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'Veterinary technicians and technicians must complete a postsecondary program, pass a credentialing exam, and hold a state registration, license, or certification depending on where they work, per BLS. Despite that formal gate, the $45,980 median sits close to two allied roles that require no degree at all: [medical assistants](/medical-assistant-salary/), whose typical entry-level education is a postsecondary nondegree award, have a median of $45,690, just $290 below veterinary technicians; [dental assistants](/dental-assistant-salary/), also entering with a nondegree award, have a median of $47,300, about $1,320 above. On this specific comparison, the extra one-to-two years of formal veterinary technology coursework and a licensing exam do not correspond to noticeably higher typical pay than assistant-level roles that require neither.',
			...
			},
			{
				...
				body: [
					"BLS reports that veterinary services employed 89% of the 134,200 veterinary technologists and technicians working in 2024. That industry pays $45,740, the second-highest of the four categories BLS tracks, about $5,510 (roughly 12%) below the highest-paying category, educational services, at $51,250, which employed only about 4% of the workforce. Social advocacy organizations and other personal services, the two lowest-paying categories, each employed roughly 1%. In practical terms, the setting employing the vast majority of the workforce pays close to, not far below, the top of what BLS tracks for this occupation. That gap is wider than the same comparison for [veterinarians](/veterinarian-salary/), where 83% of the workforce works in an industry just $1,770 below the top category, versus the $5,510 gap here.",
...
answer: "BLS files this job under a longer official name (see above), but the pay figure attached to it is simple enough: $55,010 for the year, per its May 2025 release, translating to $26.45 hourly. The lowest-paid tenth of the field fell under $33,350; the highest-paid tenth topped $88,620.",
			...
			{
				question: 'What is the highest paying job in the funeral industry?',
				answer: "Per BLS, the highest-paying title on the same funeral-service page is Funeral Home Manager (SOC 11-9171), at a $78,790 median in May 2025, about $23,780 above the $55,010 funeral director figure this page covers. That role oversees the administrative and financial end of running the operation, and BLS notes people typically spend several years as a licensed director first, so the higher-paying role is usually a step up rather than a separate entry point.",
			},
		],
		sources: [
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					"BLS's Quick Facts box for this page only shows one combined figure for \"radiologic and MRI technologists\" (278,100 jobs in 2025, projected to reach 293,300 by 2035, 5% growth, adding 15,100 positions). But the Job Outlook tab includes a separate Employment Projections Data table that breaks that combined total out by the two specific SOC codes. For MRI technologists (29-2035) alone, BLS projects growth from 43,900 jobs in 2025 to 47,300 by 2035, an 8% increase, adding 3,400 positions. Radiologic technologists and technicians (29-2034), the larger of the two occupations by headcount, are projected to grow from 234,200 to 246,000 jobs, a 5% increase adding 11,800 positions. A much smaller, slower-growing occupation by comparison, this site\'s [funeral director wage data](/funeral-director-salary/) covers morticians, undertakers, and funeral arrangers, with BLS projecting just 3% growth through 2035.",
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					"BLS breaks out May 2025 wages by industry for veterinarians, and the four categories it tracks sit closer together than the percentile spread above might suggest. Social advocacy organizations paid the highest median, at $131,760, but veterinary services, the industry that covers ordinary clinical practice, paid $129,990, just $1,770 below the top category. Educational services (state, local, and private) paid $121,890, and government work, excluding state and local education and hospitals, paid the least of the four, at $115,210.",
					"BLS's separate Work Environment data shows that 83% of veterinarians work in veterinary services, the industry paying $129,990, second only to social advocacy organizations and just $1,770 below it. Self-employed workers account for another 7%, with government (2%), educational services (2%), and social advocacy organizations (1%) making up the rest. That is a closer match between where the jobs are and where the pay is than this site found for [veterinary technicians](/veterinary-technician-salary/), a closely related occupation where BLS reports 89% of the workforce works in veterinary services, which pays $45,740 there, about $5,510 (roughly 12%) below that field's highest-paying category, educational services, at $51,250. In both occupations, the industry employing most of the workforce turns out to be the second-highest-paying one BLS tracks, not the lowest, though the gap to the top is far smaller for veterinarians than for veterinary technicians.",
				],
			},
			{
				heading: 'Becoming a veterinarian, and how the entry path compares to becoming a veterinary technician',
				body: [
					'Per BLS, prospective veterinarians need a Doctor of Veterinary Medicine (DVM or VMD) degree from an accredited college of veterinary medicine, a program that typically takes four years and combines classroom instruction, laboratory work, and clinical training, with the final year spent on clinical rotations. All states require completing an accredited program and passing a qualifying exam; most states also require a separate state-level exam covering state veterinary laws and regulations, and BLS notes that few states accept a license issued by another state without additional steps.',
					'Independently of BLS, the accrediting body behind that "accredited college" requirement is the American Veterinary Medical Association\'s Council on Education, and the field\'s national licensing exam, the North American Veterinary Licensing Examination (NAVLE), is administered by the International Council for Veterinary Assessment (ICVA, formerly named the National Board of Veterinary Medical Examiners), a computer-based test now offered during three testing windows a year that fulfills a core licensure requirement in every U.S. state and Canadian province. Candidates generally must be enrolled in, or have graduated from, an AVMA-accredited program to sit for it.',
			...
			},
			{
				...
				body: [
					'BLS projects 9% employment growth for veterinarians from 2025 to 2035, classified as much faster than the roughly 3% average across all occupations, taking the occupation from 91,100 to a projected 99,600 jobs (a BLS-published figure that does not sum exactly from the 91,100 and 8,600 above, since BLS rounds each figure independently) and adding about 8,600 positions. BLS attributes that growth to rising consumer spending on pet care, expanding treatment options, and a pet population that is both growing and aging, without assigning a specific weight to any one of those three factors. About 3,100 openings are projected each year on average over the decade, and BLS attributes many of those annual openings to workers transferring to other occupations or leaving the labor force entirely, such as to retire, rather than to newly created positions alone.',
		...
		faq: [
			...
			},
			{
				...
				answer: 'Among the four industry categories BLS tracks for May 2025, social advocacy organizations paid the highest median at $131,760, just $1,770 above veterinary services ($129,990), the industry covering ordinary clinical practice and where 83% of veterinarians actually work, per BLS. Educational services paid $121,890, and government work (excluding state and local education and hospitals) paid the least, at $115,210.',
			},
			{
				question: 'Do veterinarians need a doctoral degree?',
				answer: "Yes. BLS lists a doctoral or professional degree as the typical entry-level education, specifically a Doctor of Veterinary Medicine (DVM or VMD) from an accredited college, a program that typically takes four years. Independently of BLS, that accreditation comes from the AVMA's Council on Education, and all states also require passing a qualifying exam, most commonly the North American Veterinary Licensing Examination (NAVLE), administered by the International Council for Veterinary Assessment.",
			},
			{
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Two other occupations in that same comparison table sit well below the radiation therapist median at the identical associate\'s-degree entry level: cardiovascular technologists and technicians at $74,310, and [respiratory therapists](/respiratory-therapist-salary/) at $82,280. BLS does not explain on this page why occupations requiring the same typical degree land at such different pay levels; the gap likely reflects differences in the specialized, cancer-treatment-specific training radiation therapy programs require beyond the general associate\'s-degree credential.',
				],
			},
			{
	...
	},
	{
		...
		description: "29 of the 48 occupations WageLark tracks list an entry education below a bachelor's degree. Ranked by BLS median pay, the top one clears $148,000 a year.",
		published: '2026-08-29',
		updated: '2026-09-23',
		coreSummary: "Of the 48 occupations WageLark tracks BLS wage data for, 29, or 60%, list an entry-level education below a bachelor's degree. The highest-paying of them, air traffic controllers, has a median annual wage of $148,080, more than 42 of the other 47 occupations on this site, ahead of several that require at least a bachelor's degree.",
		sections: [
			{
				heading: "The 10 highest-paying occupations that don't require a four-year degree",
				body: [
					"Every wage figure below comes straight from the BLS Occupational Employment and Wage Statistics (OEWS) data already cited on this site's individual salary pages, filtered down to the 29 occupations (of the 48 covered here) where BLS lists the typical entry-level education as something short of a bachelor's degree: high school diploma, some college with no degree, a postsecondary nondegree award, an associate's degree, or a state-approved training program. Ranked by median annual wage, the top 10 span aviation, healthcare technician roles, and the skilled trades:",
					'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;font-size:0.9rem;min-width:520px;"><thead><tr><th style="text-align:left;padding:8px 10px;border-bottom:2px solid var(--ink);">Rank</th><th style="text-align:left;padding:8px 10px;border-bottom:2px solid var(--ink);">Occupation</th><th style="text-align:left;padding:8px 10px;border-bottom:2px solid var(--ink);">BLS entry education</th><th style="text-align:right;padding:8px 10px;border-bottom:2px solid var(--ink);">Median annual wage</th></tr></thead><tbody><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">1</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/air-traffic-controller-salary/">Air Traffic Controllers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$148,080</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">2</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/mri-tech-salary/">Magnetic Resonance Imaging Technologists</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$95,480</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">3</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-lineman/">Electrical Power-Line Installers and Repairers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$95,320</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">4</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/dental-hygienist-salary/">Dental Hygienists</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$94,260</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">5</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/ultrasound-tech-salary/">Diagnostic Medical Sonographers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$89,340</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">6</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/respiratory-therapist-salary/">Respiratory Therapists</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$80,450</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">7</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/radiology-tech-salary/">Radiologic Technologists and Technicians</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$77,660</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">8</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-court-reporter/">Court Reporters and Simultaneous Captioners</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$67,310</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">9</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/what-does-a-millwright-do/">Millwrights</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$65,700</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">10</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/plumbing-apprenticeship/">Plumbers, Pipefitters, and Steamfitters</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$63,800</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">11</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-much-do-flight-attendants-make/">Flight Attendants</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$63,580</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">12</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/electrician-salary/">Electricians</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$63,190</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">13</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/surgical-tech-salary/">Surgical Technologists</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$62,830</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">14</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-paralegal/">Paralegals and Legal Assistants</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$61,010</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">15</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/chef-salary/">Chefs and Head Cooks</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$60,990</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">16</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/hvac-certification/">Heating, Air Conditioning, and Refrigeration Mechanics and Installers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$59,810</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">17</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/firefighter-salary/">Firefighters</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$59,280</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">18</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-paramedic/">Paramedics</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$58,410</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">19</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/truck-driver-salary/">Heavy and Tractor-trailer Truck Drivers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$57,440</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">20</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/funeral-director-salary/">Morticians, Undertakers, and Funeral Arrangers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$55,010</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">21</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/welder-salary/">Welders, Cutters, Solderers, and Brazers</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$53,750</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">22</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/what-does-a-bookkeeper-do/">Bookkeeping, Accounting, and Auditing Clerks</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Some college, no degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$49,210</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">23</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/dental-assistant-salary/">Dental Assistants</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$47,300</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">24</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/veterinary-technician-salary/">Veterinary Technologists and Technicians</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Associate\'s degree</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$45,980</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">25</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/medical-assistant-salary/">Medical Assistants</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$45,690</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">26</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-phlebotomist/">Phlebotomists</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Postsecondary nondegree award</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$43,660</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">27</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/pharmacy-technician-salary/">Pharmacy Technicians</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">High school diploma or equivalent</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$43,460</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">28</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-cna/">Nursing Assistants</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">State-approved training program</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$42,260</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">29</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);"><a href="/how-to-become-a-bartender/">Bartenders</a></td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">No formal educational credential</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$33,530</td></tr></tbody></table></div>',
					"All 29 are listed with sources in the downloadable dataset linked at the bottom of this page. The full spread runs from air traffic controllers at $148,080 down to bartenders at $33,530, a nearly $115,000 gap within a group whose only shared trait, per BLS's classification, is skipping the four-year-degree requirement to enter.",
				],
			},
			{
				heading: "What BLS's education label leaves out",
				body: [
					"\"No bachelor's degree required\" is not the same as \"no training required,\" and the top of this list makes that clearest. BLS lists an associate's degree as the typical entry path for [air traffic controllers](/air-traffic-controller-salary/), but getting hired actually requires completing an FAA-approved collegiate program or several years of qualifying work experience, passing a medical and background screen, and then finishing training at the FAA Academy before ever working a live position, per this site's air traffic controller salary page. The role also carries an entry age cutoff (generally 31, extended to 35 for some applicants) and a mandatory retirement age of 56, neither of which shows up in a one-line education field.",
					"The same gap shows up further down the list. [Firefighters](/firefighter-salary/) and [paramedics](/how-to-become-a-paramedic/) are both coded as \"postsecondary nondegree award,\" a category that in practice covers a fire academy plus, for many departments, EMT or paramedic certification stacked on top. [Electricians](/electrician-salary/) and [plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/) both fall under \"high school diploma or equivalent,\" the same label BLS uses for occupations with a few weeks of on-the-job training, even though a standard electrical or plumbing apprenticeship runs four to five years at roughly 2,000 paid hours a year. The education field on this list, and on the BLS pages it comes from, describes the minimum credential to be considered for the role. It does not describe how long it actually takes to become fully qualified, and that gap is bigger for some occupations on this list than others.",
				],
			},
			{
				heading: 'A pattern in where the pay actually is',
				body: [
					"Two clusters account for most of this list. Healthcare technician roles that require an accredited program and, in most states, a license or certification exam make up five of the top seven: MRI technologists, dental hygienists, diagnostic medical sonographers, respiratory therapists, and radiologic technologists all pay a median above $77,000. The other cluster is licensure- or apprenticeship-gated trades and public-safety roles: electrical linework and plumbing, alongside [court reporting](/how-to-become-a-court-reporter/), a field where BLS lists a postsecondary nondegree award rather than a bachelor's degree, but where working in a legal setting typically also requires a state license or professional certification on top of that program.",
					"What both clusters share is a credentialing bottleneck of some kind, a licensing board, an accredited program with limited seats, or a certification exam, that keeps supply from expanding as fast as it might for an occupation with the same pay and open entry. [Bookkeeping, accounting, and auditing clerks](/what-does-a-bookkeeper-do/), the one occupation on the full 29-item list BLS projects will shrink over the next decade (down 6%, mostly from software automating routine reconciliation work), sits near the bottom of this ranking at $49,210 and has no equivalent licensing bottleneck protecting it. That contrast is suggestive, not proof; BLS publishes wage and outlook data without explaining why any single occupation pays what it pays, and this page reports the pattern rather than asserting the bottleneck causes the pay level.",
				],
			},
			{
		...
		faq: [
			{
				question: "What is the highest-paying job that doesn't require a college degree?",
				answer: "Out of every no-degree-required role in WageLark's BLS wage database, none pays more than the top-ranked role that guides planes, listed above: BLS puts the pay at $148,080 a year for May 2025. Getting hired still means clearing an FAA-vetted training track and passing through FAA Academy instruction, along with an age-based hiring window, even though the formal education requirement tops out at a two-year associate credential.",
			},
			{
				question: "Do any no-degree jobs pay over $100,000?",
				answer: "Just one clears six figures at the median: the $148,080 figure for guiding planes described above. Three runners-up land just shy of it: MRI technologists at $95,480, electrical power-line installers (linemen) at $95,320, and the dental-hygiene role at $94,260. Each role's own page on this site shows top earners clearing $120,000 or more.",
			},
			{
				question: "Does BLS's entry-level education field mean that's all the training you need?",
				answer: "No. It describes the baseline entry credential BLS uses to classify an occupation, not the full path to being hired. A handful of the roles ranked above, notably the aviation and firefighting entries, require additional academy training, licensing exams, or apprenticeship hours well beyond the listed credential. Check the individual page for each role for the specific path.",
			},
			{
				question: 'How many of the occupations on this site require a four-year degree or more?',
				answer: "Nineteen of WageLark's 48 tracked roles set four-year-degree attainment or higher as their typical BLS-listed education floor; the remaining majority, 29 roles, sit below that bar.",
			},
		],
		sources: [
			{ label: 'U.S. Bureau of Labor Statistics, Occupational Outlook Handbook (accessed 2026-08-29; underlying occupation data published May 2024 and May 2025, per occupation)', url: 'https://www.bls.gov/ooh/' },
		],
	...
	},
	{
		...
		faq: [
			...
			{
				question: 'Is it hard to become an optometrist?',
				answer: "It's a multi-year, multi-exam sequence rather than a single hurdle. Getting into an accredited O.D. program generally requires passing the OAT entrance exam first, then completing four years of doctoral coursework and hands-on clinical instruction on top of the three to four years of undergraduate study most applicants already have. Licensing afterward means clearing every section of NBEO's exam, a basic-science portion, a patient-care portion, and often a separate hands-on practical test, a heavier lift than the single licensing exam covered on this site's veterinarian page. None of that comes with an official difficulty rating; it's simply the four-year graduate track this profession runs on.",
			},
		],
		sources: [
	...
	},
	{
		...
		faq: [
			...
			{
				question: 'Is it difficult to become a lab tech?',
				answer: "It depends which of the two BLS-tracked paths someone takes. Entering as a technician typically takes a two-year credential. Entering as a technologist typically takes a full four-year undergraduate program instead. Either way, the usual next step is earning a professional credential, most commonly ASCP's MLS or MLT designation, through a NAACLS-accredited program and a certification exam. It's a real, multi-step process rather than something picked up purely on the job, though BLS itself doesn't rate either path's difficulty.",
			},
		],
		sources: [
	...
	{
		slug: 'genetic-counselor-salary',
		category: 'Salary Guide',
		title: 'Genetic Counselor Salary: $100,040 Median (2026 BLS)',
		description: "BLS puts the median genetic counselor salary at $100,040 a year, well above the $64,330 for school counselors, with 10% projected job growth through 2035.",
		published: '2026-09-10',
		updated: '2026-09-10',
		socCode: '29-9092',
		coreSummary: "Per the U.S. Bureau of Labor Statistics, genetic counselors earned a median of $100,040 in May 2025, or $48.09 an hour. Earners in the bottom 10% made less than $78,270, and those in the top 10% cleared $138,760, a range of roughly $60,490. Genetic counselors clear the $50,980 median BLS reports across all U.S. occupations by a wide margin, and beat the $64,330 median for [school and career counselors](/how-to-become-a-school-counselor/) by $35,710, despite the shared \"counselor\" label and a similarly typical master's-degree entry point. BLS counted 4,200 genetic counselors in 2025, a small workforce by this site's standards, and projects 10% growth through 2035, adding roughly 400 jobs, well ahead of the 3% average across all occupations.",
		sections: [
			{
				heading: 'What genetic counselors earn, and what BLS says they actually do',
				body: [
					"A genetic counselor earned a median of $100,040 a year in May 2025, or $48.09 an hour, per the Bureau of Labor Statistics, which profiles this occupation on its own dedicated page under SOC code 29-9092. The bottom 10% of earners made less than $78,270 a year, while the top 10% made more than $138,760, a spread of roughly $60,490. BLS counted 4,200 genetic counselors nationwide in 2025, a small occupation in headcount terms compared with most of the roles this site tracks.",
					"BLS describes the job itself as assessing a client's risk for inherited conditions, such as birth defects, then reviewing genetic test results with individuals and families and helping them work through decisions based on those results; genetic counselors also pass that information along to other healthcare providers involved in a client's care. Most work full time, primarily in hospitals, physicians' offices, outpatient care centers, university medical centers, and diagnostic laboratories.",
				],
			},
			{
				heading: "Two jobs share the word \"counselor\" on this site, but not much else",
				body: [
					"BLS separately tracks [school and career counselors and advisors](/how-to-become-a-school-counselor/) under a different SOC code, with a May 2025 median of $64,330, or $30.93 an hour, $35,710 below what genetic counselors earn. Both occupations typically require a master's degree for entry, and both usually require a state-issued credential to practice, so the pay gap is not a matter of one job asking for more schooling than the other on paper.",
					"What differs is the degree itself and who issues the credential. BLS says school counselors typically need a master's degree in school counseling or a related field, plus a state credential that may be called a certification, a license, or an endorsement, with the specific exam varying by state (many use a Praxis test, though Texas uses its own). Genetic counselors instead need a master's degree specifically in genetic counseling from a program accredited by the Accreditation Council for Genetic Counseling (ACGC), and licensure in most states typically requires passing a national board exam rather than a state-specific one, discussed further below. The two occupations sit in entirely separate parts of BLS's classification system despite the shared job title word, which is a reminder that \"counselor\" alone does not tell a reader much about degree requirements or pay on this site.",
				],
			},
			{
				heading: 'Industry pay spans about $49,000, and physician offices pay the least of the five settings',
				body: [
					"BLS breaks out May 2025 wages across five industry categories for genetic counselors. Outpatient care centers paid the highest median, at $143,620, followed by medical and diagnostic laboratories at $108,640, private colleges, universities, and professional schools at $106,710, and hospitals (state, local, and private) at $102,140. Offices of physicians paid the least of the five, at $94,380, a gap of $49,240 between the highest- and lowest-paying settings.",
					"That ordering runs counter to an assumption some readers might make, that an individual physician's practice is where genetic counselors are paid the most, since it is a setting closely tied to direct patient care. BLS does not explain the gap on this page; a plausible factor, not a claim BLS itself makes, is that outpatient care centers and larger laboratory or hospital systems may see higher volumes of referred, complex cases and can operate under different compensation structures than an individual physician's practice.",
				],
			},
			{
				heading: "A master's-only field that already out-earns one occupation requiring a doctorate",
				body: [
					"Per BLS, genetic counselors typically need a master's degree in genetic counseling, and nearly all states require them to be licensed, with licensure usually requiring board certification. BLS does not name the certifying body on its own page; it directs readers to their state's medical board for licensing specifics and separately points to CareerOneStop for certification information. Independently of BLS, that certification is the Certified Genetic Counselor (CGC) credential, issued by the American Board of Genetic Counseling (ABGC) to candidates who complete an ACGC-accredited master's program and pass a 200-question exam (170 scored questions plus 30 unscored pretest items) administered over four hours through the testing company Prometric. The field's primary professional association, the National Society of Genetic Counselors (NSGC), was incorporated in 1979 and remains the largest membership organization for genetic counselors in the U.S. and Canada.",
					"Against other advanced-degree occupations this site tracks, the $100,040 genetic counselor median already beats the $94,310 BLS reports for [psychologists](/how-to-become-a-psychologist/), an occupation whose largest specialty group typically requires a doctoral degree rather than a master's (that psychologist figure is for May 2024, the most recently published data on that page, rather than the May 2025 year used above). It still trails [physician assistants](/physician-assistant-salary/) at $133,260, another occupation that, like genetic counseling, typically enters with a master's degree (also a May 2024 figure). BLS does not explain why two master's-entry occupations land $33,220 apart, or why a master's-only field outpaces one that often requires a doctorate; the comparison describes what each occupation's own BLS profile reports, not a claim that one degree path pays better than another for a given reader. Another small master's-entry field, [orthotists and prosthetists](/orthotist-and-prosthetist-salary/), sits well below genetic counselors at an $81,110 median even with a residency added to the degree.",
					"BLS projects 10% employment growth for genetic counselors from 2025 to 2035, classified as much faster than the average for all occupations, adding an estimated 400 jobs to the 4,200-person 2025 workforce. About 300 openings a year, on average, are projected over the decade, a figure that works out to roughly 3,000 openings across the full ten years against a total net headcount gain of only 400, meaning BLS attributes the large majority of those openings to people transferring to other occupations or leaving the labor force rather than to new positions being created.",
				],
			},
		],
		faq: [
			{
				question: 'What is the median genetic counselor salary?',
				answer: "BLS's 2025 median for this occupation is $100,040 a year, equivalent to $48.09 hourly, a full $35,710 above the $64,330 it reports for school counseling, a separately credentialed occupation with an overlapping job title.",
			},
			{
				question: 'What is the pay range for genetic counselors?',
				answer: "For May 2025, per BLS, the bottom tenth earned under $78,270 a year while the top tenth topped $138,760, roughly a $60,490 spread between the two.",
			},
			{
				question: 'Which industry pays genetic counselors the most?',
				answer: "Ambulatory, outpatient-based settings top BLS's May 2025 numbers at $143,620, and testing labs come in second at $108,640. A physician's own practice trails all five tracked settings at $94,380, the lowest despite being one of the more common places to find this role.",
			},
			{
				question: 'Do genetic counselors need to be licensed?',
				answer: "Per BLS, the overwhelming majority of states require it, and getting licensed usually means clearing a national exam first. This site independently identified who administers that exam: ABGC grants the CGC credential once a candidate finishes an accredited graduate track and clears its four-hour, 200-question test.",
			},
			{
		...
		sources: [
			...
			{ label: 'American Board of Genetic Counseling (ABGC): About the CGC Credential, used for the certifying-body and exam-requirement details above (independently confirmed, not a BLS-sourced detail)', url: 'https://www.abgc.net/Certify/About-the-CGC-Credential' },
			{ label: 'National Society of Genetic Counselors (NSGC): organization history, used for the professional-association detail above (independently confirmed, not a BLS-sourced detail)', url: 'https://www.nsgc.org/' },
		],
		image: '/images/genetic-counselor-salary-chart.svg',
		imageAlt: 'Bar chart showing genetic counselor annual wage by percentile: 10th percentile $78,270, median $100,040, 90th percentile $138,760, based on BLS May 2025 data.',
	},
	{
		slug: 'audiologist-salary',
		category: 'Salary Guide',
		title: 'Audiologist Salary: $95,780 Median (2026 BLS)',
		description: 'BLS puts the median audiologist salary at $95,780 a year, above the $50,980 median for all U.S. occupations, with 11% projected job growth through 2035.',
		published: '2026-09-11',
		updated: '2026-09-11',
		socCode: '29-1181',
		coreSummary: "Audiologists earned a median of $95,780 in May 2025, per the Bureau of Labor Statistics, working out to $46.05 an hour. The bottom 10% of earners made less than $64,610, and the top 10% cleared $133,120, a range of roughly $68,510. That places audiologists $44,800 above the $50,980 median BLS reports across all U.S. occupations, though the field still trails speech-language pathologists ($97,870) by $2,090 despite requiring a four-year clinical doctorate rather than speech-language pathology's typical master's. BLS counted 14,200 audiologists in 2025 and projects 11% growth through 2035, much faster than average, adding roughly 1,600 jobs.",
		sections: [
			{
				heading: 'The $95,780 median, from percentile spread to job outlook',
				body: [
					"The U.S. Bureau of Labor Statistics puts the median audiologist salary at $95,780 a year, or $46.05 an hour, for May 2025, on the dedicated occupational profile it maintains under SOC code 29-1181. Earners in the bottom 10% made less than $64,610, while the top 10% cleared $133,120, a spread of about $68,510 between the two ends. BLS counted 14,200 audiologists nationally in 2025 and projects the field will grow 11% through 2035, a pace BLS classifies as much faster than average across all U.S. occupations. That growth is expected to add roughly 1,600 jobs to the current headcount, with about 600 openings projected each year on average, most tied to workers leaving the field rather than to newly created positions.",
					"BLS describes the work itself as diagnosing, managing, and treating patients who have hearing, balance, or related problems, which includes examining the outer, middle, and inner ear, fitting and dispensing hearing aids and other assistive listening devices, and counseling patients and families on communication strategies such as lip reading. Most audiologists work full time in healthcare settings such as physicians' offices, dedicated audiology clinics, and hospitals; a smaller share work in schools or travel between facilities under contract.",
				],
			},
			{
				heading: "A four-year doctorate that still trails an adjacent master's field by $2,090",
				body: [
					"Entering audiology requires a doctor of audiology (Au.D.) degree, a four-year program built on top of a bachelor's degree, covering anatomy and physiology, diagnosis and treatment, and statistics alongside supervised clinical practice, per BLS. That is a longer, more advanced credential than the master's degree BLS lists as the typical entry point for speech-language pathologists, a field audiologists often work alongside in outpatient therapy settings and that BLS groups together with audiology in some of its own industry statistics. Yet BLS's dedicated page for that occupation puts the May 2025 median for speech-language pathologists at $97,870, a full $2,090 above what audiologists earn despite the shorter degree path.",
					"The gap widens against [optometrists](/optometrist-salary/), another occupation requiring a doctoral or professional degree rather than a master's. BLS reports a May 2025 median of $136,570 for optometrists, $40,790 above the audiologist figure. BLS does not explain why two doctoral-entry occupations land that far apart; a plausible factor it does not state outright is that optometry combines routine eye care with product sales, such as eyewear and contact lenses, in a way audiology's hearing-aid dispensing only partly mirrors. That is offered as a possible explanation, not a claim BLS itself makes.",
				],
			},
			{
				heading: 'Hospitals pay the most, therapy-group offices pay the least',
				body: [
					"BLS breaks out May 2025 wages for audiologists across four industry categories. Hospitals (state, local, and private) paid the highest median, at $103,700, followed by educational services (state, local, and private) at $98,110 and offices of physicians at $92,620. Offices of physical, occupational, and speech therapists, and audiologists, the multi-specialty outpatient-therapy setting that includes many independent audiology practices, paid the least of the four tracked categories, at $81,730, a gap of $21,970 between the highest- and lowest-paying settings.",
					"That ordering means the industry category most closely tied to audiologists' day-to-day field, shared with physical, occupational, and speech therapy practices, is where BLS records the lowest pay for the occupation, while a larger institutional setting like a hospital system pays the most. BLS does not explain the gap on this page; a plausible factor, not a claim BLS itself makes, is that hospital-based roles may involve more complex diagnostic caseloads or sit under different reimbursement and staffing structures than a smaller outpatient therapy practice.",
				],
			},
			{
				heading: 'Licensure is mandatory everywhere; a voluntary credential can stand in for parts of it',
				body: [
					"Per BLS, all states require audiologists to be licensed, with requirements typically including an Au.D. from an accredited program; BLS does not set a single national requirement, so it directs readers to their state licensing board for specifics, and separately points to CareerOneStop for information on voluntary certifications. Independently of BLS, one such credential is ABA Certified, issued by the American Board of Audiology (ABA), a branch of the American Academy of Audiology (AAA). Per ABA's published requirements, the credential can substitute for documenting Praxis exam scores or supervised clinical experience when applying for a license in 18 jurisdictions (17 states plus the District of Columbia), including California, Florida, Georgia, Pennsylvania, and Texas, and is separately accepted as one of two certifications that satisfy a state-mandated certification requirement in ten other states, including Massachusetts, Nevada, and Virginia.",
					"AAA, the parent organization behind ABA certification, was founded in January 1988, when a group of audiology leaders convened at the invitation of Dr. James Jerger at Baylor College of Medicine in Houston to explore forming an independent national association for the field; it now describes itself as \"the largest professional organization of, by and for audiologists.\" Against another highly credentialed occupation this site tracks, [physician assistants](/physician-assistant-salary/) report a May 2024 median of $133,260, the most recently published figure on that page and a year older than the audiologist data above, which is $37,480 above what audiologists earn despite typically requiring only a master's degree rather than a four-year clinical doctorate.",
				],
			},
		],
		faq: [
			{
				question: 'What is the median audiologist salary?',
				answer: "For May 2025, BLS puts it at $95,780 annually, which works out to roughly $46 for each hour on the clock, across a workforce of 14,200 nationwide.",
			},
			{
				question: 'What is the pay range for audiologists?',
				answer: "Per BLS's May 2025 numbers, the bottom tenth earned under $64,610 while the top tenth cleared $133,120, roughly $68,510 apart.",
			},
			{
				question: 'Which industry pays audiologists the most?',
				answer: "Hospitals top BLS's May 2025 list at $103,700. The bottom spot, $81,730, belongs to the combined therapy-office category, which happens to be where a good number of standalone hearing clinics get filed.",
			},
			{
				question: 'Do audiologists need a doctoral degree?',
				answer: "Yes, per BLS: entry runs through a four-year Au.D. program taken after an undergraduate degree, and a state license is a further, non-optional step in all 50 states.",
			},
			{
		...
		sources: [
			...
			{ label: "BLS Occupational Outlook Handbook: Speech-Language Pathologists (accessed 2026-09-11 via direct fetch, returned 200, data from May 2025, last modified August 27, 2026, used for the cross-occupation pay comparison above)", url: 'https://www.bls.gov/ooh/healthcare/speech-language-pathologists.htm' },
			{ label: 'American Board of Audiology (ABA) / American Academy of Audiology (AAA): ABA Certification FAQ, used for the state-by-state licensure-substitution detail above (independently confirmed, not a BLS-sourced detail)', url: 'https://www.audiology.org/american-board-of-audiology/aba-certification/' },
			{ label: 'American Academy of Audiology: About the Academy, used for the founding-date detail above (independently confirmed, not a BLS-sourced detail)', url: 'https://www.audiology.org/about/' },
		],
		image: '/images/audiologist-salary-chart.svg',
		imageAlt: 'Bar chart showing audiologist annual wage by percentile: 10th percentile $64,610, median $95,780, 90th percentile $133,120, based on BLS May 2025 data.',
	},
	{
		slug: 'forensic-scientist-salary',
		category: 'Salary Guide',
		title: 'Forensic Scientist Salary: $72,060 Median (2026 BLS)',
		description: 'BLS puts the median forensic scientist salary at $72,060 a year, above the $50,980 median for all U.S. occupations, with 13% projected job growth through 2035.',
		published: '2026-09-11',
		updated: '2026-09-11',
		socCode: '19-4092',
		coreSummary: "Forensic science technicians, the official BLS title behind the common search term \"forensic scientist,\" earned a median of $72,060 in May 2025, working out to $34.65 an hour. The bottom 10% of earners made less than $48,250, and the top 10% cleared $117,250, a spread of roughly $69,000. That places the occupation $21,080 above the $50,980 median BLS reports across all U.S. occupations, and $9,130 above clinical laboratory technologists, an occupation BLS itself lists as sharing similar duties and degree requirements. BLS counted 20,100 forensic science technicians in 2025 and projects 13% growth through 2035, much faster than average, adding roughly 2,700 jobs and about 2,800 openings a year on average.",
		sections: [
			{
				heading: 'The $72,060 median, from percentile spread to job outlook',
				body: [
					"The U.S. Bureau of Labor Statistics puts the median forensic scientist salary at $72,060 a year, or $34.65 an hour, for May 2025, tracked under SOC code 19-4092, which BLS titles \"Forensic Science Technicians.\" Earners in the bottom 10% made less than $48,250, while the top 10% cleared $117,250, a spread of about $69,000 between the two ends. BLS counted 20,100 forensic science technicians nationally in 2025 and projects the field will grow 13% through 2035, a pace BLS classifies as much faster than average across all U.S. occupations. That growth is expected to add roughly 2,700 jobs to the current headcount, with about 2,800 openings projected each year on average, most tied to workers transferring to other occupations or leaving the labor force rather than to newly created positions alone.",
					"BLS splits the job into two working environments that carry different day-to-day duties. At the crime scene, technicians analyze what evidence should be collected, photograph and sketch the scene, record the location and position of evidence, collect items ranging from weapons and fingerprints to bodily fluids, and reconstruct how the scene likely unfolded. In the laboratory, technicians run chemical, biological, and microscopic analyses on evidence taken from crime scenes, examine DNA test results, prepare technical reports with statistical analysis, and consult with specialists in fields such as toxicology and odontology. BLS notes many technicians handle both sets of duties, while others specialize, such as a ballistics specialist who compares spent cartridge cases against a national digital database and refers likely matches to a forensic scientist for confirmation.",
				],
			},
			{
				heading: "A bachelor's degree, not a police academy: what BLS says about entry",
				body: [
					"Per BLS, forensic science technicians typically need at least a bachelor's degree to enter the occupation, drawn from fields such as physical science, biology, or forensic science, with an associate's degree sufficient for some positions. Forensic science programs themselves may specialize further, in areas such as toxicology, pathology, or DNA analysis. BLS draws one distinction worth flagging for anyone picturing a TV crime-scene investigator: some crime scene investigators who work for police departments are sworn police officers who met the educational requirements for a police academy rather than the bachelor's-degree path described here, and BLS covers that separate role on its own profile for police and detectives.",
					"Beyond the degree, BLS says forensic science technicians receive on-the-job training before working cases independently, typically under a year depending on the laboratory specialty, with newly hired crime scene technicians supervised by experienced workers while they learn evidence-collection procedures. Licenses and certifications are not required to enter the occupation, per BLS, though a technician may need to pass a state proficiency exam, testing laboratory science topics, pattern recognition, and reading and writing comprehension, or otherwise gain approval from a laboratory or accrediting body before performing independent casework. CareerOneStop, a U.S. Department of Labor resource, is where BLS points readers for details on available voluntary certifications.",
				],
			},
			{
				heading: 'Government labs and courts pay more than private testing labs',
				body: [
					"BLS breaks out May 2025 wages for forensic science technicians across four industry categories. State government (excluding education and hospitals) paid the highest median, at $74,740, followed by local government (excluding education and hospitals) at $70,050 and educational services at $61,680. Testing laboratories and services, the private-sector setting many people might assume is the norm for this field, paid the least of the four tracked categories, at $49,600, a gap of $25,140 between the highest- and lowest-paying settings BLS lists here.",
					"BLS does not explain the gap on this page, but the pattern lines up with how forensic evidence actually gets processed in the U.S.: most crime labs that handle criminal casework sit inside state or local government, often attached to a police department, sheriff's office, or medical examiner's office, while private testing laboratories more often handle non-criminal work such as paternity testing or workplace drug screening. That is offered as a plausible explanation drawn from the industry categories BLS publishes, not a claim BLS itself makes about why one setting pays more than another.",
				],
			},
			{
				heading: 'Against other lab-science occupations this site tracks',
				body: [
					"BLS's own Similar Occupations table for forensic science technicians names [clinical laboratory technologists and technicians](/clinical-laboratory-technologist-salary/) as a comparable role by job duties and degree requirement. BLS reports a May 2025 median of $62,930 for that occupation, $9,130 below the forensic science technician figure above, even though the forensic role's bachelor's-degree bar matches only half of that combined BLS page: technologists typically need a bachelor's degree, but technicians on the same page can sometimes qualify with an associate's degree instead. BLS's similar-occupations table also lists chemists and materials scientists at a May 2025 median of $95,060 and chemical technicians, which typically require only an associate's degree, at $60,390, though neither of those two has a dedicated page on this site yet.",
					"Against [radiation therapists](/radiation-therapist-salary/), an occupation this site tracks that typically needs only an associate's degree, BLS reports a May 2025 median of $105,310, $33,250 above the forensic science technician figure despite the shorter typical training path. BLS does not weigh how much of that gap traces to differences in clinical risk, licensing burden, or the healthcare-reimbursement structures that fund radiation therapy versus the government budgets that fund most crime labs; the comparison describes what BLS's own entry-education and pay tables show side by side, not a claim about which credential is the better investment for a given reader.",
				],
			},
		],
		faq: [
			{
				question: 'What is the median forensic scientist salary?',
				answer: "This occupation goes by several informal names online, but BLS tracks it under its own occupation code, 19-4092: a $72,060 median wage for May 2025, close to $34.65 hourly, among 20,100 workers nationwide.",
			},
			{
				question: 'What is the pay range for forensic science technicians?',
				answer: "Low earners, in the bottom 10%, stayed under $48,250 in May 2025, while the top decile passed $117,250, roughly a $69,000 range per BLS's own numbers. The agency does not publish a finer percentile breakdown on this occupation's page.",
			},
			{
				question: 'What degree do you need to become a forensic scientist?',
				answer: "Typically a four-year, bachelor's-level degree, per BLS, commonly earned in biology, physical science, or a dedicated forensic-science program, though a two-year associate's credential covers a handful of positions. Readers picturing a badge-carrying officer handling crime-scene duties should know that role falls under a separate profile BLS keeps for law enforcement, covering detectives and uniformed officers, not this degree track.",
			},
			{
				question: 'Which industry pays forensic science technicians the most?',
				answer: 'State government jobs apart from schools, colleges, and hospitals pay best, a $74,740 median for May 2025. Independent testing labs and services pay least of the four wage categories BLS tracks, $49,600, since more of that work is civil rather than criminal casework.',
			},
			{
	...
	},
	{
		...
		faq: [
			...
			{
				question: 'Is SLP a stressful job?',
				answer: "BLS doesn't rate occupations for stress, but it does describe a demanding path and a varied caseload. Per BLS, the role spans several settings at once, hospitals, doctors' offices, schools, and long-term care, often with clients whose needs range from stutters to feeding and voice disorders. Getting there already requires a mentored post-graduate fellowship, 1,260-plus hours spread over 36 weeks or more, before full certification, on top of a master's degree, pointing to substantial day-to-day demands even though BLS itself doesn't use the word \"stressful.\"",
			},
			{
				question: 'Is speech pathology harder than nursing?',
				answer: "BLS doesn't rate occupations by difficulty, but the credentialing timelines and structure differ. This career takes a master's degree, about two years past a bachelor's, then, under ASHA's certification framework, a mentored post-graduate fellowship of 1,260-plus hours over 36 weeks or more and a passing exam score before full certification. Registered nursing typically moves faster: per this site's [how long is nursing school](/how-long-is-nursing-school/) guide, BLS lists both the bachelor's (BSN) and associate's (ADN/ASN) nursing paths at about four years to completion, without an equivalent post-graduation fellowship requirement.",
			},
		],
		sources: [
	...
	},
	{
		...
		sections: [
			...
			{
				heading: "How much does the typical American worker earn in 2026?",
				body: [
					"The most common occupation pays far less than the highest-paid one, and the gap between them runs into the hundreds of thousands of dollars a year.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Home health and personal care aides make up the single largest occupation in the country, employing <strong>4.3 million</strong> people, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li><li style="line-height:1.6;">Pediatric surgeons are the highest-paid occupation BLS tracks nationally, with a mean annual wage of <strong>$502,050</strong>, followed by cardiologists at $454,940, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>. This site has more detail on one physician specialty, <a href="/psychiatrist-salary/">psychiatrist pay</a>.</li><li style="line-height:1.6;">Nurse anesthetists, at <strong>$248,320</strong>, are the highest-paid occupation in the country that isn\'t a physician, surgeon, or dentist role, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li><li style="line-height:1.6;">Of the 10 largest occupations in the U.S., only registered nurses ($101,420) and general and operations managers ($134,940) pay above the $69,770 national average wage. The other eight range from $32,150 for fast food and counter workers to $46,590 for customer service representatives, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li><li style="line-height:1.6;">Government jobs account for <strong>14.6%</strong> of total U.S. employment, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li></ul>',
				],
			},
			{
				heading: "Does a college degree still change how much you're paid?",
				body: [
					"Yes, and the gap widens the further up the pay scale you look.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Among hourly-paid workers 25 and older, 1.5% of those without a high school diploma earned at or below the federal minimum wage in 2024, versus about 1.0% for high school graduates, workers with some college, and bachelor\'s degree holders, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Report 1115, June 2025</a>.</li><li style="line-height:1.6;">At the top of the pay scale, the highest-earning 10% of full-time workers with an advanced degree made at least <strong>$5,363</strong> a week for men and <strong>$3,676</strong> a week for women in Q2 2026, per <a href="https://www.bls.gov/news.release/wkyeng.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Q2 2026</a>.</li><li style="line-height:1.6;">New bachelor\'s graduates in computer and information sciences had the highest average starting salary among the Class of 2025, at <strong>$91,517</strong>, up 2.9% from the year before. For a look at pay without that degree at all, see the site\'s <a href="/highest-paying-jobs-without-a-degree/">no-degree occupation ranking</a>. The computer-sciences figure is per <a href="https://www.naceweb.org/job-market/compensation/starting-salaries-climb-for-the-class-of-2025" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Sept. 2026</a>.</li><li style="line-height:1.6;">Class of 2026 master\'s degree graduates in computer sciences are projected to average <strong>$94,212</strong>, a 10.9% jump from last year\'s $84,960, per <a href="https://www.naceweb.org/job-market/compensation/class-of-2026-computer-sciences-grads-expected-to-be-highest-paid-at-masters-level" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Feb. 2026</a>.</li></ul>',
				],
			},
			{
				heading: "Is the pay gap between men and women closing or widening?",
				body: [
					"By the Census Bureau's own year-over-year comparison, it widened in 2024, the second year in a row that happened.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Full-time, year-round median earnings rose 3.7% for men between 2023 and 2024, with no statistically significant change for women, per the <a href="https://www.census.gov/library/publications/2025/demo/p60-286.html" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">U.S. Census Bureau, Sept. 2025</a>.</li><li style="line-height:1.6;">The gender pay gap widens with age: women 16 to 24 earned 91.1% of what men the same age earned in Q2 2026, while women 55 and older earned only <strong>78.5%</strong> of their male peers\' pay, per <a href="https://www.bls.gov/news.release/wkyeng.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Q2 2026</a>.</li><li style="line-height:1.6;">In management and professional occupations, the best-paid major job category, full-time men earned a median <strong>$1,928</strong> a week in Q2 2026, compared with $1,476 for women, per <a href="https://www.bls.gov/news.release/wkyeng.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Q2 2026</a>.</li><li style="line-height:1.6;">Service occupations were the lowest-paid major job category: $920 a week for men and <strong>$730</strong> for women in Q2 2026, per <a href="https://www.bls.gov/news.release/wkyeng.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Q2 2026</a>.</li></ul>',
				],
			},
			{
				heading: "How does pay differ by race and ethnicity?",
				body: [
					"BLS's weekly-earnings survey shows the gap is widest between Hispanic and Asian workers, and it persists within the same gender.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Median weekly earnings by race and ethnicity in Q2 2026: Asian workers $1,713, White workers $1,268, Black workers $1,029, Hispanic workers <strong>$997</strong>, per <a href="https://www.bls.gov/news.release/wkyeng.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Q2 2026</a>.</li><li style="line-height:1.6;">Among men, Black workers\' median weekly earnings ($1,089) were 77.8% of White men\'s ($1,400); Hispanic men\'s earnings ($1,080) were <strong>77.1%</strong> of White men\'s, in Q2 2026, per <a href="https://www.bls.gov/news.release/wkyeng.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Q2 2026</a>.</li><li style="line-height:1.6;">Between 2023 and 2024, median household income rose 5.5% for Hispanic households and 5.1% for Asian households, while it fell <strong>3.3%</strong> for Black households, per the <a href="https://www.census.gov/library/publications/2025/demo/p60-286.html" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">U.S. Census Bureau, Sept. 2025</a>.</li><li style="line-height:1.6;">Black workers had the highest union membership rate of any racial group in 2025, at <strong>11.4%</strong>, compared with 9.9% for White workers, 8.9% for Hispanic workers, and 8.7% for Asian workers, per <a href="https://www.bls.gov/news.release/union2.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Union Members, Feb. 2026</a>.</li></ul>',
				],
			},
			{
				heading: "Which industries and occupations pay the most, and which pay the least?",
				body: [
					"Healthcare pays among the most of any major occupation group BLS tracks, well ahead of construction and education, though not the single highest.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Healthcare practitioners and technical occupations, one of the higher-paying major groups BLS tracks, had a mean wage of <strong>$108,700</strong> across 9.8 million jobs, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li><li style="line-height:1.6;">Registered nurses, the largest healthcare occupation at 3.4 million jobs, had a mean wage of $101,420 nationally, ranging from about $77,000 in Alabama and South Dakota to <strong>$150,280</strong> in California, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li><li style="line-height:1.6;">Educational instruction and library occupations employed 9.1 million people at a mean wage of $67,540. Elementary school teachers averaged $72,650, ranging from $52,300 in Mississippi to <strong>$97,970</strong> in Washington state, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li><li style="line-height:1.6;">Construction and extraction occupations employed 6.4 million people, 4.1% of the national workforce, at a mean wage of <strong>$65,360</strong>, below the $69,770 national average, per <a href="https://www.bls.gov/news.release/ocwage.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, May 2025</a>.</li></ul>',
				],
			},
			{
				heading: "Are wages actually keeping up with inflation?",
				body: [
					"Not for private-industry workers as a group, once the numbers are adjusted for the Consumer Price Index.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Real average hourly earnings for all U.S. employees fell <strong>0.3%</strong> between August 2025 and August 2026, even as nominal average hourly earnings rose, once the Consumer Price Index is factored in, per <a href="https://www.bls.gov/news.release/realer.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Real Earnings, Sept. 2026</a>.</li><li style="line-height:1.6;">Real average weekly earnings still rose 0.3% over that same year, because the average workweek lengthened <strong>0.6%</strong>, per <a href="https://www.bls.gov/news.release/realer.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Real Earnings, Sept. 2026</a>.</li><li style="line-height:1.6;">Compensation costs for state and local government workers rose <strong>3.6%</strong> over the year ending June 2026, faster than the 3.4% gain for civilian workers overall, per <a href="https://www.bls.gov/news.release/eci.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Employment Cost Index, Aug. 2026</a>.</li><li style="line-height:1.6;">Household income at the 90th percentile rose <strong>4.2%</strong> between 2023 and 2024, while income at the 10th and 50th percentiles showed no statistically significant change, per the <a href="https://www.census.gov/library/publications/2025/demo/p60-286.html" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">U.S. Census Bureau, Sept. 2025</a>.</li></ul>',
				],
			},
			{
				heading: "How much do employers spend on top of the paycheck?",
				body: [
					"Benefits account for roughly three to four of every ten dollars an employer spends on compensation, and the share is higher in government jobs than in private industry.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">For full-time private-industry workers, total compensation averaged <strong>$54.00</strong> an hour in June 2026, versus $25.20 an hour for part-time workers, per <a href="https://www.bls.gov/news.release/ecec.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Employer Costs for Employee Compensation, Sept. 2026</a>.</li><li style="line-height:1.6;">Benefits made up 30.0% of total compensation costs for private-industry workers in June 2026, versus <strong>38.8%</strong> for state and local government workers, per <a href="https://www.bls.gov/news.release/ecec.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Sept. 2026</a>.</li><li style="line-height:1.6;">Full-time private-industry workers received $4.40 an hour in paid-leave benefits and <strong>$3.76</strong> an hour in legally required benefits (Social Security, Medicare, unemployment insurance) as of June 2026, per <a href="https://www.bls.gov/news.release/ecec.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Sept. 2026</a>.</li><li style="line-height:1.6;">Part-time private-industry workers received just <strong>$0.90</strong> an hour in paid-leave benefits, a fifth of the full-time figure, per <a href="https://www.bls.gov/news.release/ecec.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Sept. 2026</a>.</li></ul>',
				],
			},
			{
				heading: "Does union membership still come with a pay premium?",
				body: [
					"Yes, and the premium BLS reports has held for decades even as the union membership rate itself has fallen.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">The U.S. union membership rate was <strong>10.0%</strong> in 2025, down from 20.1% when comparable records began in 1983, per <a href="https://www.bls.gov/news.release/union2.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Union Members, Feb. 2026</a>.</li><li style="line-height:1.6;">Public-sector workers were more than five times as likely to belong to a union as private-sector workers in 2025: <strong>32.9%</strong> versus 5.9%, per <a href="https://www.bls.gov/news.release/union2.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Feb. 2026</a>.</li><li style="line-height:1.6;">Local government had the highest union membership rate of any sector, at <strong>37.8%</strong> in 2025, per <a href="https://www.bls.gov/news.release/union2.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Feb. 2026</a>.</li><li style="line-height:1.6;">Education, training, and library occupations had the highest unionization rate of any occupational group, at 32.5%, followed by protective service occupations at <strong>31.3%</strong>, per <a href="https://www.bls.gov/news.release/union2.nr0.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, Feb. 2026</a>.</li></ul>',
				],
			},
			{
				heading: "Who actually earns the federal minimum wage?",
				body: [
					"A small and specific slice of the workforce: mostly young, mostly part-time, and concentrated in food service.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">Thirty states plus Washington, D.C. had minimum wages above the $7.25 federal floor as of 2024, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS Report 1115, June 2025</a>.</li><li style="line-height:1.6;">Workers under 25 made up one-fifth of all hourly-paid workers in 2024 but <strong>43%</strong> of those earning at or below the federal minimum wage, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, June 2025</a>.</li><li style="line-height:1.6;">Among teenagers 16 to 19 paid by the hour, 2.6% earned at or below the federal minimum in 2024, nearly four times the <strong>0.7%</strong> rate for workers 25 and older, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, June 2025</a>.</li><li style="line-height:1.6;">Part-time hourly workers were four times as likely as full-time workers to earn at or below the federal minimum in 2024: <strong>2.4%</strong> versus 0.6%, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, June 2025</a>.</li><li style="line-height:1.6;">Nearly three-quarters of all workers earning the federal minimum wage or less in 2024 worked in service occupations, mostly food preparation and serving, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, June 2025</a>.</li><li style="line-height:1.6;">Louisiana and South Carolina had the highest share of hourly workers earning at or below the federal minimum in 2024, both at or just above <strong>2.0%</strong>, per <a href="https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">BLS, June 2025</a>.</li></ul>',
				],
			},
			{
				heading: "What are new college graduates earning in 2026?",
				body: [
					"Starting pay keeps climbing, but the size of the increase varies sharply by major and by year.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;">The Class of 2024\'s final average starting salary, $65,677, was up just 2.2% from the Class of 2023, after two much larger increases: 7.1% for the Class of 2023 and <strong>7.4%</strong> for the Class of 2022, per <a href="https://www.naceweb.org/job-market/compensation/average-starting-salary-for-class-of-2024-shows-mild-gain" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Aug. 2025</a>.</li><li style="line-height:1.6;">Class of 2026 bachelor\'s degree salary projections range from a 1.7% expected decline for social sciences majors to a <strong>6.9%</strong> increase for computer sciences majors, per <a href="https://www.naceweb.org/job-market/compensation/class-of-2026-salary-projections-are-promising" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Jan. 2026</a>.</li><li style="line-height:1.6;">Within engineering, petroleum engineering has the highest projected starting salary among the Class of 2026, at <strong>$100,750</strong>, per <a href="https://www.naceweb.org/job-market/compensation/class-of-2026-salary-projections-are-promising" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Jan. 2026</a>.</li><li style="line-height:1.6;">At the master\'s degree level, Class of 2025 engineering graduates saw projected salaries climb 12.5% to $94,086, and business graduates climbed 3.1% to <strong>$77,632</strong>, both following declines the year before, per <a href="https://www.naceweb.org/job-market/compensation/class-of-2025-engineering-business-grads-expected-to-see-salaries-climb-at-the-masters--level" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Feb. 2025</a>.</li><li style="line-height:1.6;">The average hourly wage for bachelor\'s-level interns reached <strong>$23.04</strong> in 2024, the tenth straight year of increases, though it was down 1.1% after adjusting for inflation since 2015, per <a href="https://www.naceweb.org/job-market/compensation/average-hourly-wage-for-interns-exceeds-23-dollars" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">NACE, Mar. 2025</a>.</li></ul>',
				],
			},
			{
				heading: "How confident are workers about negotiating their pay?",
				body: [
					"Most professionals say they feel ready to negotiate, and most hiring managers say they're bracing for it.",
					'<ul style="margin:0;padding-left:1.2em;display:flex;flex-direction:column;gap:10px;color:var(--ink);font-size:0.9375rem;"><li style="line-height:1.6;"><strong>88%</strong> of professionals say they feel confident negotiating salary when given a job offer, per <a href="https://www.roberthalf.com/us/en/insights/salary-guide" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">Robert Half 2026 Salary Guide</a>.</li><li style="line-height:1.6;">74% of hiring managers say they worry about keeping up with candidates\' compensation expectations through 2026, per <a href="https://www.roberthalf.com/us/en/insights/salary-guide" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">Robert Half, 2026</a>.</li><li style="line-height:1.6;">53% of workers say they would switch jobs for better financial incentives like bonuses or stock options, and <strong>66%</strong> of professionals say they would come into the office five days a week for higher pay, per <a href="https://www.roberthalf.com/us/en/insights/salary-guide" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">Robert Half, 2026</a>.</li><li style="line-height:1.6;">Half of hiring managers predict that adding new benefits and perks will be an effective strategy for recruiting skilled candidates in 2026, per <a href="https://www.roberthalf.com/us/en/insights/salary-guide" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);">Robert Half, 2026</a>.</li></ul>',
				],
			},
			{
		...
		faq: [
			{
				question: "What is the average salary in the United States in 2026?",
				answer: "It depends which average is meant. Federal wage surveys covering about 830 individual occupations show a national average near $69,770 a year as of 2025. A separate federal survey of entire households, which counts every earner and every income source under one roof, put the typical U.S. household at $83,730 in 2024. Neither number describes what a single worker takes home; they measure different things and shouldn't be swapped for one another.",
			},
			{
				question: "Is the gender pay gap getting better or worse?",
				answer: "It widened in the government's most recent annual comparison. Among people working full time all year, women earned just under 81 cents for every dollar men earned in 2024, a smaller share than the year before, extending a two-year run of that ratio slipping rather than growing.",
			},
			{
				question: "How much has the minimum wage changed recently?",
				answer: "It hasn't. The federal floor has sat at $7.25 an hour for more than a decade and a half, unchanged since mid-2009. States are free to set a higher local minimum, and most now do: as of 2024, thirty of them and the nation's capital required more than the federal rate.",
			},
			{
		...
		sources: [
			...
			{ label: 'U.S. Bureau of Labor Statistics: Usual Weekly Earnings of Wage and Salary Workers, Second Quarter 2026 (accessed 2026-09-13 via direct fetch, returned 200, USDL-26-1257)', url: 'https://www.bls.gov/news.release/wkyeng.nr0.htm' },
			{ label: 'U.S. Bureau of Labor Statistics: Employment Cost Index, June 2026 (accessed 2026-09-13 via direct fetch, returned 200, last modified August 3, 2026)', url: 'https://www.bls.gov/news.release/eci.nr0.htm' },
			{ label: 'U.S. Bureau of Labor Statistics: Real Earnings, August 2026 (accessed 2026-09-13 via direct fetch, returned 200, USDL-26-1497)', url: 'https://www.bls.gov/news.release/realer.nr0.htm' },
			{ label: 'U.S. Bureau of Labor Statistics: Employer Costs for Employee Compensation, June 2026 (accessed 2026-09-13 via direct fetch, returned 200, USDL-26-1494)', url: 'https://www.bls.gov/news.release/ecec.nr0.htm' },
			{ label: 'U.S. Bureau of Labor Statistics: Union Members -- 2025 (accessed 2026-09-13 via direct fetch, returned 200, USDL-26-0229)', url: 'https://www.bls.gov/news.release/union2.nr0.htm' },
			{ label: 'U.S. Bureau of Labor Statistics: Characteristics of Minimum Wage Workers, 2024, BLS Report 1115 (accessed 2026-09-13 via direct fetch, returned 200, published June 2025)', url: 'https://www.bls.gov/opub/reports/minimum-wage/2024/home.htm' },
			{ label: 'U.S. Department of Labor, Wage and Hour Division: Minimum Wage (accessed 2026-09-13 via direct fetch, returned 200, evergreen reference page)', url: 'https://www.dol.gov/agencies/whd/minimum-wage' },
			{ label: 'U.S. Census Bureau: Income in the United States: 2024, Report P60-286 (accessed 2026-09-13 via direct fetch, returned 200, published September 9, 2025)', url: 'https://www.census.gov/library/publications/2025/demo/p60-286.html' },
			{ label: 'Federal Reserve Bank of Atlanta: Wage Growth Tracker (accessed 2026-09-13 via direct fetch, returned 200, updated September 10, 2026, data through August 2026)', url: 'https://www.atlantafed.org/chcs/wage-growth-tracker' },
			{ label: 'Robert Half: 2026 Salary Guide (accessed 2026-09-13 via direct fetch, returned 200)', url: 'https://www.roberthalf.com/us/en/insights/salary-guide' },
			{ label: 'National Association of Colleges and Employers (NACE): Starting Salaries Climb for the Class of 2025 (accessed 2026-09-13 via direct fetch, returned 200, published September 3, 2026)', url: 'https://www.naceweb.org/job-market/compensation/starting-salaries-climb-for-the-class-of-2025' },
			{ label: 'NACE: Class of 2026 Computer Sciences Grads Expected to Be Highest Paid at Master\'s Level (accessed 2026-09-13 via direct fetch, returned 200, published February 9, 2026)', url: 'https://www.naceweb.org/job-market/compensation/class-of-2026-computer-sciences-grads-expected-to-be-highest-paid-at-masters-level' },
			{ label: 'NACE: Class of 2026 Salary Projections Are Promising (accessed 2026-09-13 via direct fetch, returned 200, published January 26, 2026)', url: 'https://www.naceweb.org/job-market/compensation/class-of-2026-salary-projections-are-promising' },
	...
	{
		slug: 'ironworker-salary',
		category: 'Salary Guide',
		title: 'Ironworker Salary: $62,780 Median (2026 BLS)',
		description: 'BLS puts the median structural ironworker salary at $62,780, but its own data shows two trades hiding under one job title, with opposite 10-year outlooks.',
		published: '2026-09-15',
		updated: '2026-09-15',
		socCode: '47-2221',
		coreSummary: "The U.S. Bureau of Labor Statistics tracks \"ironworkers\" as two distinct occupations under one Occupational Outlook Handbook page: structural iron and steel workers (SOC 47-2221) and reinforcing iron and rebar workers (SOC 47-2171). Structural ironworkers, who erect the steel frames of buildings, bridges, and towers, earned a median of $62,780 in May 2025, with the bottom 10% under $44,580 and the top 10% over $108,260. Reinforcing ironworkers, who install rebar inside poured concrete, earned less at every level: a $58,970 median, $43,310 at the 10th percentile, and $104,540 at the 90th. BLS projects the two trades will head in opposite directions over the next decade: 3% growth for structural iron and steel workers, roughly the same pace as the U.S. economy overall, against a 5% decline for reinforcing iron and rebar workers, a split the combined \"Ironworkers\" headline figure BLS publishes (1% growth, 84,800 workers in 2025) blends into one number.",
		sections: [
			{
				heading: "The $62,780 median, and why \"ironworker\" is really two jobs",
				body: [
					"Per BLS, the median annual wage for structural iron and steel workers, the trade most people picture when they hear \"ironworker,\" the crews who bolt and weld together the steel skeletons of buildings, bridges, and towers, was $62,780 in May 2025. The bottom 10% of earners made less than $44,580, while the top 10% cleared $108,260, a spread of roughly $63,680 between the extremes. That $62,780 median sits within about $1,000 of what BLS reports for electricians and plumbers, two other high school diploma-entry trades this site covers, and its $108,260 top-decile figure lands almost exactly on top of theirs too, a pattern detailed further down this page. For where that figure falls against the wider U.S. labor market, see this site's [roundup of national wage statistics](/salary-statistics-2026/).",
					"BLS's Occupational Outlook Handbook page titled \"Ironworkers\" actually covers a second, separate occupation with its own six-digit SOC code: reinforcing iron and rebar workers, who install the steel reinforcing bars inside concrete before it's poured, rather than erecting structural steel frames. That trade earned less at every point BLS measures for May 2025: a $58,970 median, $3,810 below the structural figure, with a $43,310 to $104,540 spread between its 10th and 90th percentiles. The two trades share entry requirements and many of the same apprenticeship programs, but BLS tracks them as distinct occupations in its pay tables, not interchangeable titles for the same job.",
				],
			},
			{
				heading: 'Same page, opposite 10-year outlooks',
				body: [
					"BLS's employment projections for this page split even further than pay does. Structural iron and steel workers are projected to grow 3% from 2025 to 2035, in line with the roughly 3% growth BLS projects across all U.S. occupations combined. Reinforcing iron and rebar workers are projected to shrink 5% over the same period, one of relatively few occupations on this site with a declining outlook rather than flat or growing employment. Blended together, those two trends average out to the 1% \"slower than average\" figure BLS publishes as the combined \"Ironworkers\" headline number, a single stat that obscures a real divergence between the two trades it covers.",
					'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;font-size:0.9rem;min-width:480px;"><thead><tr><th style="text-align:left;padding:8px 10px;border-bottom:2px solid var(--ink);"></th><th style="text-align:right;padding:8px 10px;border-bottom:2px solid var(--ink);">Structural iron and steel workers</th><th style="text-align:right;padding:8px 10px;border-bottom:2px solid var(--ink);">Reinforcing iron and rebar workers</th></tr></thead><tbody><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Median annual wage</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">$62,780</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;">$58,970</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">10th percentile</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;">$44,580</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;">$43,310</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">90th percentile</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;">$108,260</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;">$104,540</td></tr><tr><td style="padding:8px 10px;border-bottom:1px solid var(--rule);">Job outlook, 2025-35</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;font-weight:600;">+3%</td><td style="padding:8px 10px;border-bottom:1px solid var(--rule);text-align:right;">-5%</td></tr><tr><td style="padding:8px 10px;">Top-paying industry (May 2025)</td><td style="padding:8px 10px;text-align:right;">Heavy/civil engineering construction, $73,470</td><td style="padding:8px 10px;text-align:right;">Nonresidential building construction, $64,010</td></tr></tbody></table></div>',
					"BLS does not explain the split on this page. One plausible read, drawn only from the industry wage tables BLS does publish: structural steel work leans more on heavy and civil engineering construction, at $73,470 a year the highest-paying industry for that trade, a category that includes bridges, highways, and other infrastructure with a large public-funding component. Reinforcing work is more tied to nonresidential building construction specifically, at $64,010 its own top-paying industry, which may track more closely with private commercial building cycles. That's offered as a plausible explanation grounded in that industry breakdown, not a claim BLS makes about the cause.",
				],
			},
			{
				heading: 'How to become an ironworker',
				body: [
					"Per BLS, ironworkers typically need only a high school diploma or equivalent to enter the trade, the same nominal bar as electricians, welders, and several other trades this site covers. Most learn through a 3- or 4-year apprenticeship, sponsored by unions and contractor associations, and BLS notes that nearly all of these programs teach both reinforcing and structural ironworking rather than specializing apprentices into just one track from the start. Each year of the program requires at least 144 hours of related technical instruction plus 2,000 hours of paid on-the-job training, per BLS, putting a full apprenticeship at somewhere between 432 and 576 classroom hours and 6,000 to 8,000 paid field hours depending on length. Apprentices typically start around half of what a journey-level ironworker earns and receive raises as they take on more of the job; completing the program makes someone a journey-level worker able to perform tasks without direct supervision.",
					"BLS also flags a scheduling difference between the two trades worth knowing before choosing either path: structural ironworkers, who often work at significant heights, don't work in wet, icy, or extremely windy conditions, while reinforcing ironworkers, who work closer to ground level tying rebar, may still be limited by precipitation but face fewer weather-driven stoppages tied to height and wind. Most ironworkers of either type work full time, per BLS.",
				],
			},
			{
				heading: 'How ironworker pay compares with other no-degree trades',
				body: [
					"Against other high school diploma-entry trades this site has covered, structural ironworker pay lands close to the middle of the pack at the median but converges sharply at the top end. [Electricians](/electrician-salary/) have a slightly higher median, $63,190 versus $62,780 for structural ironworkers, and their top decile, $108,510, sits within $250 of the ironworker figure above. [Plumbers, pipefitters, and steamfitters](/plumbing-apprenticeship/) run close behind at a $63,800 median with a $108,420 top decile, again within a few hundred dollars of both trades. Three separate BLS occupations, three different training paths and licensing structures, and all three converge on roughly $108,000 to $109,000 for their highest-paid 10%, a pattern BLS does not call out but that its own percentile tables show clearly side by side.",
					"[Welders, cutters, solderers, and brazers](/welder-salary/) trail noticeably behind at every point BLS measures, a $53,750 median with a $77,530 top decile, roughly $30,700 below the structural ironworker ceiling despite a similar high school diploma entry bar and comparable use of cutting and joining equipment on the job. At the other extreme, [electrical power-line installers and repairers](/how-to-become-a-lineman/), commonly called linemen, post a $95,320 median well above any of the trades here, reflecting the additional CDL and specialized high-voltage training that role typically requires on top of the same nominal high school diploma bar. BLS does not weigh how much of these gaps trace to licensing requirements, physical risk, or regional demand for each trade; the comparison describes what BLS's own tables report side by side, not a claim about which path suits a given reader.",
				],
			},
		],
		faq: [
			{
				question: 'What is the median ironworker salary?',
				answer: "BLS actually tracks two separate trades under this one title. Crews who fasten up steel building frames brought home a $62,780 midpoint wage in May 2025; crews who tie rebar into wet concrete before it sets trailed a bit behind at $58,970 that same year.",
			},
			{
				question: 'Do ironworkers make six figures?',
				answer: "Top performers in either specialty do. BLS's 90th-percentile figures for May 2025 run to $108,260 for steel-frame crews and $104,540 for rebar crews, both past six figures, though a typical worker in either specialty takes home far less than that.",
			},
			{
				question: 'Where do ironworkers get paid the most?',
				answer: "It comes down to which industry hires them, not one standout employer. Steel-frame crews peak on infrastructure work, roads and bridges and similar heavy-construction projects, at roughly $73,470 for May 2025, well above that specialty's overall midpoint. Rebar-tying crews peak elsewhere, on commercial and institutional building jobs, at $64,010.",
			},
			{
				question: 'Do ironworkers make $400 an hour?',
				answer: "Nothing in BLS's May 2025 numbers supports that claim. Even the best-paid tenth of steel-frame crews, over $108,000 a year, comes out to roughly $52 an hour across a standard 2,080-hour work year, nowhere close to $400.",
			},
			{
				question: 'Is ironworking a growing career?',
				answer: "The two specialties aren't moving in sync. BLS expects roughly 3% more jobs for steel-frame crews between 2025 and 2035, close to the nationwide pace, but a 5% pullback for rebar-tying crews over that decade. Blend the two together and BLS's combined figure for the occupation comes out to just 1% growth and about 6,800 yearly openings.",
			},
			{
		...
		sources: [
			{ label: 'BLS Occupational Outlook Handbook: Ironworkers (accessed 2026-09-15 via direct fetch with a UA string carrying a declared contact email, returned 200, data from May 2025, last modified August 27, 2026; covers both structural iron and steel workers (SOC 47-2221) and reinforcing iron and rebar workers (SOC 47-2171) under one page, source for all pay, outlook, industry-wage, and apprenticeship detail above)', url: 'https://www.bls.gov/ooh/construction-and-extraction/structural-iron-and-steel-workers.htm' },
		],
	...
	},
	{
		...
		description: "BLS puts the median orthotist and prosthetist salary at $81,110 a year, $16,990 below dental hygienists despite requiring a master's degree and residency.",
		published: '2026-09-16',
		updated: '2026-09-26',
		socCode: '29-2091',
		coreSummary: "Per the U.S. Bureau of Labor Statistics, orthotists and prosthetists earned a median of $81,110 in May 2025, or $38.99 an hour, across a combined occupation BLS tracks under a single SOC code, 29-2091. Earners in the bottom 10% made less than $46,350, and those in the top 10% cleared $119,810, a spread of roughly $73,460. That beats the $50,980 median BLS reports across all U.S. occupations by $30,130, but it trails the $98,100 median for [dental hygienists](/dental-hygienist-salary/) by $16,990, despite dental hygiene typically requiring only an associate degree against this field's master's degree and residency. BLS counted 9,500 orthotists and prosthetists in 2025 and projects 13% growth through 2035, more than four times the roughly 3% average across all occupations.",
		sections: [
			{
		...
		sections: [
			{
				...
				body: [
					...
					"The welders figure above, $53,750, and the plumbers, pipefitters, and steamfitters figure, $63,800, both match the current May 2025 figures on [this site's welder salary page](/welder-salary/) and [plumbing page](/plumbing-apprenticeship/) exactly.",
				],
			},
			{
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'The Bureau of Labor Statistics does not track a single occupation called "pilot." Its Occupational Employment and Wage Statistics program splits flying jobs into two categories on the same Airline and Commercial Pilots page: airline pilots, copilots, and flight engineers, who fly scheduled passenger and cargo routes for major and regional airlines, and commercial pilots, who fly charter flights, aerial application, instructional flights, and other work outside scheduled airline service. The May 2025 median for the airline category was $232,140 a year; for the commercial category it was $123,220, a gap of just over $108,000 between two jobs that share a search term but not a pay scale.',
					"The size of that gap traces mostly to what each job actually is. Airline pilots typically need a bachelor's degree plus experience as a commercial or military pilot before an airline will hire them, and once hired, most fly under union contracts with structured, seniority-based pay progression. Commercial pilots typically need flight training and FAA certification instead of a four-year degree, and the work covers a much wider range of employers, from charter operators to flight schools to agricultural spraying. A search for \"how much do pilots make\" without specifying which kind is, in effect, a question about two different labor markets that happen to share a job title.",
					'Employment size differs too. BLS counted about 104,600 airline pilots, copilots, and flight engineers and about 50,400 commercial pilots in 2025, so the higher-paying airline category is also the larger of the two by headcount.',
				],
			},
			{
				heading: 'The percentile spread inside each category',
				body: [
					"Airline pilot pay is not evenly distributed even within the category. The lowest-earning 10% made less than $106,710 in May 2025, while the highest-earning 10% made more than $463,830, a spread of well over $350,000. BLS attributes most of that spread to seniority: airline pilots usually start their careers as first officers and receive wage increases as they accumulate experience and seniority, with the most senior captains at large carriers landing at the top of the range. Pilots also receive a per-diem expense allowance for every hour away from home and can earn extra pay for international flights, on top of the base wage figures reported here.",
					'Commercial pilots show a narrower but still wide range: under $58,850 at the 10th percentile to over $266,620 at the 90th. That spread reflects the variety within the category more than seniority alone. A newly certified flight instructor building hours toward an airline job and a charter pilot flying jets for a corporate operator both fall under "commercial pilots" in BLS\'s data, despite very different pay and experience levels.',
				],
				image: {
					src: '/images/commercial-pilot-salary-chart.svg',
					alt: 'Bar chart showing commercial pilot annual wage by percentile: 10th percentile $58,850, median $123,220, 90th percentile $266,620, based on BLS May 2025 data.',
				},
			},
			{
				heading: "Which employers pay the most, by BLS's industry data",
				body: [
					"For airline pilots, BLS's industry breakdown holds a surprise: the highest median pay was not at passenger airlines. Couriers and express delivery services, the cargo carriers that fly for companies like UPS and FedEx, paid a median of $334,930 in May 2025, well above the $293,240 median at scheduled air transportation, the category covering the passenger airlines most people picture when they think \"airline pilot.\" Support activities for transportation paid $202,680, and federal government employers (excluding the postal service) paid $141,140, the lowest of the four industries BLS breaks out for this occupation.",
					'Commercial pilots show a similar shape at a lower altitude. Nonscheduled air transportation, the charter-flight industry, paid the highest median at $133,150, followed by professional, scientific, and technical services at $129,610 and support activities for air transportation at $123,090. Two smaller industries round out the list: other ambulatory healthcare services, which includes air ambulance operators, paid $100,330, and private technical and trade schools, where certified flight instructors are classified, paid $93,820, the lowest median BLS reports for either pilot category.',
				],
			},
			{
				heading: 'Job outlook and how the pay ladder actually works',
				body: [
					'BLS projects 8% employment growth for airline pilots, copilots, and flight engineers from 2025 to 2035, adding about 8,700 jobs to a base of 104,600. Commercial pilots are projected to grow 5% over the same decade, adding about 2,600 jobs. Both rates beat the 3% average projected across all U.S. occupations, and BLS classifies the combined airline-and-commercial-pilot outlook as much faster than average, citing rising demand for air travel and continued e-commerce-driven freight growth as the main drivers.',
					"The path from a commercial pilot's median pay to an airline pilot's median mostly involves building flight hours and then getting hired by an airline, not a raise inside the same job. Airline pilots typically enter the field with a bachelor's degree and prior experience as a commercial or military pilot, so most of the highest earners on this page's chart started out flying lower-paying jobs first. Once hired, BLS notes pay climbs with seniority, which is a large part of why the 90th percentile for airline pilots, more than $463,830, sits over four times higher than the category's 10th percentile. Related reading on this site: [flight attendant pay](/how-much-do-flight-attendants-make/), another airline-crew role with a similarly wide, seniority-driven range, and [air traffic controller salary](/air-traffic-controller-salary/), a non-flying aviation career where BLS puts the May 2025 median at $148,080, between the two pilot figures on this page.",
				],
			},
		],
		faq: [
			...
			{
				question: 'Do plane pilots make good money?',
				answer: "By national standards, yes. BLS put the typical U.S. worker's May 2025 pay at a $50,980 median. The $123,220 figure for charter and instructional pilots is over twice that number, and the $232,140 figure for pilots on a fixed airline timetable clears it by more than four and a half times. Even the bottom tenth of that higher-paid group, just above $106,710, still beats the nationwide figure by a wide margin.",
			},
			{
				question: 'How long does it take to make $200,000 as a pilot?',
				answer: "BLS doesn't publish pay by years on the job, so there's no official timeline. Its figures do show $200,000 sits below the median for pilots flying a fixed airline timetable ($232,140) but well above the commercial-pilot median ($123,220), and BLS describes pay in the higher tier as climbing with seniority once someone starts as a first officer. In practice, clearing that mark usually means logging hours as a commercial pilot first, landing an airline seat, and working up its pay scale over a span of years, not a fixed count.",
			},
			{
				question: 'What pilots make $400,000 a year?',
				answer: "The top 10% among pilots flying a fixed airline or cargo timetable cleared $463,830 in May 2025, per BLS, well past $400,000. BLS doesn't name job titles at that level, but its industry figures point toward senior captains flying for cargo carriers: the express-delivery and courier segment logged the top wage among the industries listed for this line of work, at $334,930.",
			},
			{
				question: "What's the difference between an airline pilot and a commercial pilot, according to BLS?",
				answer: "One flies a fixed passenger or cargo timetable and generally needs a four-year degree plus prior flying experience before getting hired. The other covers work outside that structure, including charter flights, flight instruction, and crop-dusting runs, and the entry bar there runs through hands-on flying instruction plus a pilot's license from the FAA, not a college diploma. BLS tracks the two as separate occupations with a median pay gap topping $108,000.",
			},
			{
