...
export const guides: Guide[] = [
	...
	},
	{
		...
		category: 'Salary Guide',
		title: 'Electrician Salary: $62,350 Median, Range by Percentile (2026)',
	...
	},
	{
		...
		description: "29 of the 47 occupations WageLark tracks list an entry education below a bachelor's degree. Ranked by BLS median pay, the top one clears $148,000 a year.",
		published: '2026-08-29',
		updated: '2026-08-30',
		coreSummary: "Of the 47 occupations WageLark tracks BLS wage data for, 29, or 62%, list an entry-level education below a bachelor's degree. The highest-paying of them, air traffic controllers, has a median annual wage of $148,080, more than 41 of the other 46 occupations on this site, ahead of several that require at least a bachelor's degree.",
		sections: [
			{
				heading: "The 10 highest-paying occupations that don't require a four-year degree",
				body: [
					"Every wage figure below comes straight from the BLS Occupational Employment and Wage Statistics (OEWS) data already cited on this site's individual salary pages, filtered down to the 29 occupations (of the 47 covered here) where BLS lists the typical entry-level education as something short of a bachelor's degree: high school diploma, some college with no degree, a postsecondary nondegree award, an associate's degree, or a state-approved training program. Ranked by median annual wage, the top 10 span aviation, healthcare technician roles, and the skilled trades:",
		...
		faq: [
			...
			},
			{
				...
				answer: "18 of the 47 occupations WageLark currently tracks BLS wage data for list a bachelor's degree or higher as the typical entry-level education; the other 29, or 62%, list something short of that.",
			},
		],
		sources: [
