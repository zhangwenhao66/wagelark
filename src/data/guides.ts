		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Against other BLS occupations this site has covered that share the same "postsecondary nondegree award" entry-level classification, paramedic pay sits close to [firefighters](/firefighter-salary/), whose $59,280 median is about $870 above the paramedic figure, and well above [CNAs](/how-to-become-a-cna/), whose $42,260 median is roughly 38% lower despite CNA training running a federal floor of just 75 hours rather than a multi-tier certification path. BLS does not weigh how much of these gaps traces to training length, scope of practice, or the settings each occupation typically works in.',
				],
			},
			{
